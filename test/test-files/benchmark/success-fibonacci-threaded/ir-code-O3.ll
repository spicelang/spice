...
for.body.L11:
  ...
  call void @_ZN6Thread4ctorEPFCvE(ptr noundef nonnull align 8 dereferenceable(24) %0, { ptr, ptr } { ptr @_Z15lambda.L12C29.0v, ptr poison }) #4
...
declare void @_ZN6Thread4ctorEPFCvE(ptr, { ptr, ptr }) local_unnamed_addr
