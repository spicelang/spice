...
entry:
  %0 = tail call i1 @_f_bool_dirExists_string(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @5, i64 0, i64 0))
  %1 = zext i1 %0 to i32
  ...
  %4 = tail call i32 @_f_int_mkDir_string_int(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @5, i64 0, i64 0), i32 %3)
  %5 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @1, i64 0, i64 0), i32 %4)
  %6 = tail call i1 @_f_bool_dirExists_string(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @5, i64 0, i64 0))
  %7 = zext i1 %6 to i32
  %8 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([27 x i8], [27 x i8]* @2, i64 0, i64 0), i32 %7)
  %9 = tail call i32 @_f_int_rmDir_string(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @5, i64 0, i64 0))
  %10 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @3, i64 0, i64 0), i32 %9)
  %11 = tail call i1 @_f_bool_dirExists_string(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @5, i64 0, i64 0))
...
declare i1 @_f_bool_dirExists_string(i8*) local_unnamed_addr

declare i32 @_f_int_mkDir_string_int(i8*, i32) local_unnamed_addr

declare i32 @_f_int_rmDir_string(i8*) local_unnamed_addr
