...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @_ZN6VectorI9pair.PairE4ctorEv(ptr nonnull %pairVector) #2
  store i32 0, ptr %2, align 4
  store ptr @anon.string.0, ptr %3, align 8
  call void @_ZN4PairIiPcE4ctorERiRPc(ptr nonnull %1, ptr nonnull %2, ptr nonnull %3) #2
  call void @_ZN6VectorI9pair.PairE8pushBackERK9pair.Pair(ptr nonnull %pairVector, ptr nonnull %1) #2
  store i32 1, ptr %5, align 4
  store ptr @anon.string.1, ptr %6, align 8
  call void @_ZN4PairIiPcE4ctorERiRPc(ptr nonnull %4, ptr nonnull %5, ptr nonnull %6) #2
  call void @_ZN6VectorI9pair.PairE8pushBackERK9pair.Pair(ptr nonnull %pairVector, ptr nonnull %4) #2
  %7 = call ptr @_ZN6VectorI9pair.PairE3getEj(ptr nonnull %pairVector, i32 1) #2
  ...
  call void @_ZN6VectorI9pair.PairE4dtorEv(ptr nonnull %pairVector) #2
  ret i32 0
}

declare void @_ZN6VectorI9pair.PairE4ctorEv(ptr) local_unnamed_addr

declare void @_ZN4PairIiPcE4ctorERiRPc(ptr, ptr, ptr) local_unnamed_addr

declare void @_ZN6VectorI9pair.PairE8pushBackERK9pair.Pair(ptr, ptr) local_unnamed_addr

declare ptr @_ZN6VectorI9pair.PairE3getEj(ptr, i32) local_unnamed_addr
...
declare void @_ZN6VectorI9pair.PairE4dtorEv(ptr) local_unnamed_addr
