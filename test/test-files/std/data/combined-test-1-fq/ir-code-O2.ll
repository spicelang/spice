...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @"_mp__Vector_pair::Pair<int,string>__void__pushBack__pair::Pair<int,string>ref"(ptr nonnull %pairVector, ptr nonnull %1) #2
  ...
  call void @"_mp__Vector_pair::Pair<int,string>__void__pushBack__pair::Pair<int,string>ref"(ptr nonnull %pairVector, ptr nonnull %4) #2
  %p1 = call ptr @"_mf__Vector_pair::Pair<int,string>__pair::Pair<int,string>ref__get__int"(ptr nonnull %pairVector, i32 1) #2
...
declare void @"_mp__Vector_pair::Pair<int,string>__void__pushBack__pair::Pair<int,string>ref"(ptr, ptr) local_unnamed_addr
