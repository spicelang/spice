...
define dso_local i32 @main() local_unnamed_addr #0 {
  %s1 = alloca %struct.Stack, align 8
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %s1, i8 0, i64 24, i1 false)
  call void @_ZN5StackIiE4ctorEv(ptr nonnull %s1) #3
  store i32 123, ptr %1, align 4
  call void @_ZN5StackIiE4pushERKi(ptr nonnull %s1, ptr nonnull %1) #3
  store i32 456, ptr %2, align 4
  call void @_ZN5StackIiE4pushERKi(ptr nonnull %s1, ptr nonnull %2) #3
  store i32 789, ptr %3, align 4
  call void @_ZN5StackIiE4pushERKi(ptr nonnull %s1, ptr nonnull %3) #3
  %4 = call i64 @_ZN5StackIiE7getSizeEv(ptr nonnull %s1) #3
  %5 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.0, i64 %4)
  %6 = call i64 @_ZN5StackIiE11getCapacityEv(ptr nonnull %s1) #3
  %7 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.1, i64 %6)
  %8 = call ptr @_ZN5StackIiE3popEv(ptr nonnull %s1) #3
  %9 = load i32, ptr %8, align 4
  %10 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.2, i32 %9)
  %11 = call ptr @_ZN5StackIiE3popEv(ptr nonnull %s1) #3
  %12 = load i32, ptr %11, align 4
  %13 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.3, i32 %12)
  %14 = call ptr @_ZN5StackIiE3popEv(ptr nonnull %s1) #3
  %15 = load i32, ptr %14, align 4
  %16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.4, i32 %15)
  call void @_ZN5StackIiE4dtorEv(ptr nonnull %s1) #3
  ret i32 0
}

declare void @_ZN5StackIiE4ctorEv(ptr) local_unnamed_addr

declare void @_ZN5StackIiE4pushERKi(ptr, ptr) local_unnamed_addr

; Function Attrs: nofree nounwind
declare noundef i32 @printf(ptr nocapture noundef readonly, ...) local_unnamed_addr #1

declare i64 @_ZN5StackIiE7getSizeEv(ptr) local_unnamed_addr

declare i64 @_ZN5StackIiE11getCapacityEv(ptr) local_unnamed_addr

declare ptr @_ZN5StackIiE3popEv(ptr) local_unnamed_addr

declare void @_ZN5StackIiE4dtorEv(ptr) local_unnamed_addr
