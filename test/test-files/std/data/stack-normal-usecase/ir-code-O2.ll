...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @_mp__Stack_int__void__push__int(ptr nonnull %s1, i32 123) #3
  call void @_mp__Stack_int__void__push__int(ptr nonnull %s1, i32 456) #3
  call void @_mp__Stack_int__void__push__int(ptr nonnull %s1, i32 789) #3
  %1 = call i64 @_mf__Stack_int__long__getSize(ptr nonnull %s1) #3
  %2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.0, i64 %1)
  %3 = call i64 @_mf__Stack_int__long__getCapacity(ptr nonnull %s1) #3
  %4 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.1, i64 %3)
  %5 = call i32 @_mf__Stack_int__int__pop(ptr nonnull %s1) #3
  %6 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.2, i32 %5)
  %7 = call i32 @_mf__Stack_int__int__pop(ptr nonnull %s1) #3
  %8 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.3, i32 %7)
  %9 = call i32 @_mf__Stack_int__int__pop(ptr nonnull %s1) #3
