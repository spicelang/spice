...
entry.l3:
  ...
  call void @_mp__Triple_string_int_bool__void__ctor__string_int_bool(ptr nonnull %stringIntBoolTriple, ptr nonnull @0, i32 1234, i1 true)
  %0 = call ptr @_mf__Triple_string_int_bool__string__getFirst(ptr nonnull %stringIntBoolTriple)
  %1 = call i32 (ptr, ...) @printf(ptr nonnull @1, ptr %0)
  %2 = call i32 @_mf__Triple_string_int_bool__int__getSecond(ptr nonnull %stringIntBoolTriple)
  %3 = call i32 (ptr, ...) @printf(ptr nonnull @2, i32 %2)
  %4 = call i1 @_mf__Triple_string_int_bool__bool__getThird(ptr nonnull %stringIntBoolTriple)
  %5 = zext i1 %4 to i32
