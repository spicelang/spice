...
entry.l4:
  ...
  call void @"_mp__Vector_pair.Pair<int,string>__ctor"(ptr nonnull %pairVector)
  call void @_mp__Pair_int_string__ctor__int_string(ptr nonnull %0, i32 0, ptr nonnull @0)
  ...
  call void @"_mp__Vector_pair.Pair<int,string>__pushBack__pair.Pair<int,string>"(ptr nonnull %pairVector, %_s__int_string__Pair__int_string %.fca.1.insert11)
  call void @_mp__Pair_int_string__ctor__int_string(ptr nonnull %1, i32 1, ptr nonnull @1)
  ...
  call void @"_mp__Vector_pair.Pair<int,string>__pushBack__pair.Pair<int,string>"(ptr nonnull %pairVector, %_s__int_string__Pair__int_string %.fca.1.insert)
  %3 = call %_s__int_string__Pair__int_string @"_mf__Vector_pair.Pair<int,string>__get__int"(ptr nonnull %pairVector, i32 1)
  ...
  %4 = call ptr @_mf__Pair_int_string__getSecond(ptr nonnull %2)
  %5 = call i32 (ptr, ...) @printf(ptr nonnull @2, ptr %4)
  call void @"_mp__Vector_pair.Pair<int,string>__dtor"(ptr nonnull %pairVector)
  ret i32 0
}

declare void @"_mp__Vector_pair.Pair<int,string>__ctor"(ptr) local_unnamed_addr

declare void @"_mp__Vector_pair.Pair<int,string>__pushBack__pair.Pair<int,string>"(ptr, %_s__int_string__Pair__int_string) local_unnamed_addr

declare void @_mp__Pair_int_string__ctor__int_string(ptr, i32, ptr) local_unnamed_addr

declare %_s__int_string__Pair__int_string @"_mf__Vector_pair.Pair<int,string>__get__int"(ptr, i32) local_unnamed_addr

; Function Attrs: nofree nounwind
declare noundef i32 @printf(ptr nocapture noundef readonly, ...) local_unnamed_addr #0

declare ptr @_mf__Pair_int_string__getSecond(ptr) local_unnamed_addr

declare void @"_mp__Vector_pair.Pair<int,string>__dtor"(ptr) local_unnamed_addr
