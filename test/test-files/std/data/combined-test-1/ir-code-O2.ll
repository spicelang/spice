...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @"_mp__Vector_std/data/pair::Pair<int,string>__void__pushBack__std/data/pair::Pair<int,string>"(ptr nonnull %pairVector, %__int_string__Pair__int_string %.fca.1.insert12) #2
  ...
  %3 = call %__int_string__Pair__int_string @"_mf__Vector_std/data/pair::Pair<int,string>__std/data/pair::Pair<int,string>__get__int"(ptr nonnull %pairVector, i32 1) #2
