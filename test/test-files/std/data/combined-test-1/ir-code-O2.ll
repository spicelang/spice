...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @"_mp__Vector_std/data/pair::Pair<int,string>__void__dtor"(ptr nonnull %pairVector) #2
  ret i32 0
}
...
declare void @"_mp__Vector_std/data/pair::Pair<int,string>__void__dtor"(ptr) local_unnamed_addr
