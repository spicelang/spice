...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @_ZN6String4ctorEPc(ptr nonnull %s, ptr nonnull @anon.string.1) #3
  %3 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %4 = call i1 @_Z10isRawEqualPcPc(ptr %3, ptr nonnull @anon.string.1) #3
...
assert.exit.L3:                                   ; preds = %0
  %6 = call i64 @_ZN6String9getLengthEv(ptr nonnull %s) #3
  %7 = icmp eq i64 %6, 6
...
assert.exit.L4:                                   ; preds = %assert.exit.L3
  %9 = call i64 @_ZN6String11getCapacityEv(ptr nonnull %s) #3
  %10 = icmp eq i64 %9, 12
...
assert.exit.L5:                                   ; preds = %assert.exit.L4
  call void @_ZN6String6appendEPc(ptr nonnull %s, ptr nonnull @anon.string.5) #3
  %12 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %13 = call i1 @_Z10isRawEqualPcPc(ptr %12, ptr nonnull @anon.string.6) #3
...
assert.exit.L7:                                   ; preds = %assert.exit.L5
  %15 = call i64 @_ZN6String9getLengthEv(ptr nonnull %s) #3
...
assert.exit.L8:                                   ; preds = %assert.exit.L7
  %18 = call i64 @_ZN6String11getCapacityEv(ptr nonnull %s) #3
...
assert.exit.L9:                                   ; preds = %assert.exit.L8
  call void @_ZN6String6appendEh(ptr nonnull %s, i8 63) #3
  %21 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %22 = call i1 @_Z10isRawEqualPcPc(ptr %21, ptr nonnull @anon.string.10) #3
...
assert.exit.L11:                                  ; preds = %assert.exit.L9
  %24 = call i64 @_ZN6String9getLengthEv(ptr nonnull %s) #3
...
assert.exit.L12:                                  ; preds = %assert.exit.L11
  %27 = call i64 @_ZN6String11getCapacityEv(ptr nonnull %s) #3
...
assert.exit.L13:                                  ; preds = %assert.exit.L12
  call void @_ZN6String6appendEh(ptr nonnull %s, i8 33) #3
  %30 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %31 = call i1 @_Z10isRawEqualPcPc(ptr %30, ptr nonnull @anon.string.14) #3
...
assert.exit.L15:                                  ; preds = %assert.exit.L13
  %33 = call i64 @_ZN6String9getLengthEv(ptr nonnull %s) #3
...
assert.exit.L16:                                  ; preds = %assert.exit.L15
  %36 = call i64 @_ZN6String11getCapacityEv(ptr nonnull %s) #3
...
assert.exit.L17:                                  ; preds = %assert.exit.L16
  call void @_ZN6String5clearEv(ptr nonnull %s) #3
  %39 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %40 = call i1 @_Z10isRawEqualPcPc(ptr %39, ptr nonnull @anon.string.26) #3
...
assert.exit.L19:                                  ; preds = %assert.exit.L17
  %42 = call i64 @_ZN6String9getLengthEv(ptr nonnull %s) #3
  %43 = icmp eq i64 %42, 0
...
assert.exit.L20:                                  ; preds = %assert.exit.L19
  %45 = call i64 @_ZN6String11getCapacityEv(ptr nonnull %s) #3
...
assert.exit.L21:                                  ; preds = %assert.exit.L20
  call void @_ZN6String7reserveEm(ptr nonnull %s, i64 100) #3
  %48 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %49 = call i1 @_Z10isRawEqualPcPc(ptr %48, ptr nonnull @anon.string.26) #3
...
assert.exit.L23:                                  ; preds = %assert.exit.L21
  %51 = call i64 @_ZN6String9getLengthEv(ptr nonnull %s) #3
  %52 = icmp eq i64 %51, 0
...
assert.exit.L24:                                  ; preds = %assert.exit.L23
  %54 = call i64 @_ZN6String11getCapacityEv(ptr nonnull %s) #3
...
assert.exit.L25:                                  ; preds = %assert.exit.L24
  call void @_ZN6String4ctorEPc(ptr nonnull %1, ptr nonnull @anon.string.26) #3
  ...
  %57 = call i1 @_ZN6String7isEmptyEv(ptr nonnull %s) #3
...
assert.exit.L27:                                  ; preds = %assert.exit.L25
  call void @_ZN6String6appendEh(ptr nonnull %s, i8 97) #3
  %59 = call i1 @_ZN6String7isEmptyEv(ptr nonnull %s) #3
...
assert.exit.L29:                                  ; preds = %assert.exit.L27
  call void @_ZN6String4ctorEPc(ptr nonnull %2, ptr nonnull @anon.string.29) #3
  ...
  %61 = call i1 @_ZN6String7replaceEPcPc(ptr nonnull %s, ptr nonnull @anon.string.30, ptr nonnull @anon.string.34) #3
...
assert.exit.L31:                                  ; preds = %assert.exit.L29
  %63 = call i1 @_ZN6String7replaceEPcPc(ptr nonnull %s, ptr nonnull @anon.string.43, ptr nonnull @anon.string.34) #3
...
assert.exit.L32:                                  ; preds = %assert.exit.L31
  %65 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %66 = call i1 @_Z10isRawEqualPcPc(ptr %65, ptr nonnull @anon.string.36) #3
...
assert.exit.L33:                                  ; preds = %assert.exit.L32
  %68 = call i1 @_ZN6String7replaceEPcPcm(ptr nonnull %s, ptr nonnull @anon.string.43, ptr nonnull @anon.string.39, i64 45) #3
...
assert.exit.L34:                                  ; preds = %assert.exit.L33
  %70 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %71 = call i1 @_Z10isRawEqualPcPc(ptr %70, ptr nonnull @anon.string.41) #3
...
assert.exit.L35:                                  ; preds = %assert.exit.L34
  %73 = call i1 @_ZN6String7replaceEPcPc(ptr nonnull %s, ptr nonnull @anon.string.43, ptr nonnull @anon.string.44) #3
...
assert.exit.L36:                                  ; preds = %assert.exit.L35
  %75 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %76 = call i1 @_Z10isRawEqualPcPc(ptr %75, ptr nonnull @anon.string.46) #3
...
assert.exit.L37:                                  ; preds = %assert.exit.L36
  %78 = call i64 @_ZN6String10replaceAllEPcPc(ptr nonnull %s, ptr nonnull @anon.string.48, ptr nonnull @anon.string.49) #3
  %79 = icmp eq i64 %78, 3
...
assert.exit.L38:                                  ; preds = %assert.exit.L37
  %81 = call ptr @_ZN6String6getRawEv(ptr nonnull %s) #3
  %82 = call i1 @_Z10isRawEqualPcPc(ptr %81, ptr nonnull @anon.string.51) #3
...
assert.exit.L39:                                  ; preds = %assert.exit.L38
  ...
  call void @_ZN6String4dtorEv(ptr nonnull %s) #3
  ret i32 0
}
