...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @_mp__String__void__ctor__string(ptr nonnull %s, ptr nonnull @anon.string.1) #3
...
assert.exit.L33:                                  ; preds = %assert.exit.L32
  %68 = call i1 @_mf__String__bool__replace__string_string_long(ptr nonnull %s, ptr nonnull @anon.string.43, ptr nonnull @anon.string.39, i64 45) #3
