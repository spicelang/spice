...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %5 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.17, ptr %4)
  %6 = call i64 @_mf__String__long__getLength(ptr nonnull %s) #3
  %7 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.18, i64 %6)
  %8 = call i64 @_mf__String__long__getCapacity(ptr nonnull %s) #3
  %9 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.19, i64 %8)
  ...
  %30 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.13, i32 %29)
  ...
  %33 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.13, i32 %32)
  call void @_mp__String__void__clear(ptr nonnull %s) #3
  %34 = call ptr @_mf__String__charptr__getRaw(ptr nonnull %s) #3
  %35 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.17, ptr %34)
  %36 = call i64 @_mf__String__long__getLength(ptr nonnull %s) #3
  %37 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.18, i64 %36)
  %38 = call i64 @_mf__String__long__getCapacity(ptr nonnull %s) #3
  %39 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.19, i64 %38)
  ...
  %41 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.17, ptr %40)
  %42 = call i64 @_mf__String__long__getLength(ptr nonnull %s) #3
  %43 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.18, i64 %42)
  %44 = call i64 @_mf__String__long__getCapacity(ptr nonnull %s) #3
  %45 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.19, i64 %44)
  ...
  %48 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.20, i32 %47)
  call void @_mp__String__void__append__char(ptr nonnull %s, i8 97) #3
  %49 = call i1 @_mf__String__bool__isEmpty(ptr nonnull %s) #3
  %50 = zext i1 %49 to i32
  %51 = call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.21, i32 %50)
  ret i32 0
}
