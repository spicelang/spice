...
@5 = private unnamed_addr constant [15 x i8] c"Capacity: %d\0A\0A\00", align 1
...
@8 = private unnamed_addr constant [13 x i8] c"Capacity: %d\00", align 1
...
entry.l3:
  ...
  %5 = call i32 (ptr, ...) @printf(ptr nonnull @5, i64 %4)
  ...
  %11 = call i32 (ptr, ...) @printf(ptr nonnull @5, i64 %10)
  ...
  %17 = call i32 (ptr, ...) @printf(ptr nonnull @5, i64 %16)
  ...
  %23 = call i32 (ptr, ...) @printf(ptr nonnull @5, i64 %22)
  %24 = call i1 @_mf__String__opEquals__string(ptr nonnull %s, ptr nonnull @2)
  %25 = zext i1 %24 to i32
  %26 = call i32 (ptr, ...) @printf(ptr nonnull @3, i32 %25)
  %27 = call i1 @_mf__String__opEquals__string(ptr nonnull %s, ptr nonnull @4)
  %28 = zext i1 %27 to i32
  %29 = call i32 (ptr, ...) @printf(ptr nonnull @3, i32 %28)
  call void @_mp__String__clear(ptr nonnull %s)
  %30 = call ptr @_mf__String__getRaw(ptr nonnull %s)
  %31 = call i32 (ptr, ...) @printf(ptr nonnull @6, ptr %30)
  %32 = call i64 @_mf__String__getLength(ptr nonnull %s)
  %33 = call i32 (ptr, ...) @printf(ptr nonnull @7, i64 %32)
