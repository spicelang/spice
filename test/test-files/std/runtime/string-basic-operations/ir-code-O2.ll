...
entry.l3:
  ...
  call void @_mp__String__ctor__string(ptr nonnull %s, ptr nonnull @9)
  %48 = call i1 @_mf__String__isEmpty(ptr nonnull %s)
  %49 = zext i1 %48 to i32
  %50 = call i32 (ptr, ...) @printf(ptr nonnull @10, i32 %49)
  call void @_mp__String__append__char(ptr nonnull %s, i8 97)
  %51 = call i1 @_mf__String__isEmpty(ptr nonnull %s)
