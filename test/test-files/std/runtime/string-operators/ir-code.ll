...
entry.l1:
  ...
  %45 = call ptr @_mf__String__getRaw(ptr %4)
  call void @_mp__String__ctor__string_string(ptr %5, ptr %45, ptr @7)
  %46 = load %_s__String__charptr_long_long, ptr %5, align 8
  store %_s__String__charptr_long_long %46, ptr %6, align 8
  %47 = call ptr @_mf__String__getRaw(ptr %6)
  %48 = call i32 (ptr, ...) @printf(ptr @6, ptr %47)
  %49 = call ptr @_mf__String__getRaw(ptr %3)
  call void @_mp__String__ctor__string_string(ptr %7, ptr @9, ptr %49)
  %50 = load %_s__String__charptr_long_long, ptr %7, align 8
  store %_s__String__charptr_long_long %50, ptr %8, align 8
  %51 = call ptr @_mf__String__getRaw(ptr %8)
  ...
  %54 = call ptr @_mf__String__getRaw(ptr %9)
  %55 = call ptr @_mf__String__getRaw(ptr %3)
  call void @_mp__String__ctor__string_string(ptr %10, ptr %54, ptr %55)
  %56 = load %_s__String__charptr_long_long, ptr %10, align 8
  store %_s__String__charptr_long_long %56, ptr %11, align 8
  %57 = call ptr @_mf__String__getRaw(ptr %11)
  ...
  call void @_mp__String__ctor__string(ptr %35, ptr %113)
  call void @_mp__String__append__char(ptr %35, i8 108)
  %114 = call ptr @_mf__String__getRaw(ptr %35)
  %115 = call i32 (ptr, ...) @printf(ptr @43, ptr %114)
  store ptr @44, ptr %s5, align 8
  %116 = load ptr, ptr %s5, align 8
  call void @_mp__String__ctor__string(ptr %36, ptr %116)
  call void @_mp__String__append__string(ptr %36, ptr @45)
  %117 = call ptr @_mf__String__getRaw(ptr %36)
  %118 = call i32 (ptr, ...) @printf(ptr @46, ptr %117)
  store ptr @47, ptr %s6, align 8
  %119 = load ptr, ptr %s6, align 8
  call void @_mp__String__ctor__string(ptr %37, ptr %119)
  call void @_mp__String__opMul__int(ptr %37, i32 3)
  %120 = call ptr @_mf__String__getRaw(ptr %37)
...
declare void @_mp__String__ctor__string_string(ptr, ptr, ptr)

declare ptr @_mf__String__getRaw(ptr)

declare void @_mp__String__ctor__string(ptr, ptr)

declare void @_mp__String__opMul__short(ptr, i16)

declare void @_mp__String__opMul__int(ptr, i32)

declare void @_mp__String__ctor__char(ptr, i8)

declare i1 @_f__void__isRawEqual__string_string(ptr, ptr)

declare void @_mp__String__append__char(ptr, i8)

declare void @_mp__String__append__string(ptr, ptr)
