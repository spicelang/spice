...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @_ZN6String4ctorEPc(ptr nonnull %s1, ptr nonnull @anon.string.36) #2
  call void @_ZN6String4ctorEPc(ptr nonnull %s2, ptr nonnull @anon.string.30) #2
  call void @_ZN6String4ctorEPc(ptr nonnull %s3, ptr nonnull @anon.string.2) #2
  call void @_ZN6String4ctorEPc(ptr nonnull %s4, ptr nonnull @anon.string.3) #2
  %1 = call i1 @_ZN6String7isEmptyEv(ptr nonnull %s1) #2
...
assert.exit.L8:                                   ; preds = %0
  %3 = call i1 @_ZN6String7isEmptyEv(ptr nonnull %s2) #2
...
assert.exit.L9:                                   ; preds = %assert.exit.L8
  %5 = call i64 @_ZN6String9getLengthEv(ptr nonnull %s3) #2
  %6 = icmp eq i64 %5, 6
...
assert.exit.L10:                                  ; preds = %assert.exit.L9
  %8 = call i64 @_ZN6String9getLengthEv(ptr nonnull %s4) #2
  %9 = icmp eq i64 %8, 12
...
assert.exit.L11:                                  ; preds = %assert.exit.L10
  %11 = call i64 @_ZN6String11getCapacityEv(ptr nonnull %s3) #2
...
assert.exit.L12:                                  ; preds = %assert.exit.L11
  %14 = call i64 @_ZN6String11getCapacityEv(ptr nonnull %s4) #2
...
assert.exit.L13:                                  ; preds = %assert.exit.L12
  %17 = call i1 @_ZN6String6isFullEv(ptr nonnull %s2) #2
...
assert.exit.L14:                                  ; preds = %assert.exit.L13
  %19 = call i1 @_ZN6String6isFullEv(ptr nonnull %s4) #2
...
assert.exit.L15:                                  ; preds = %assert.exit.L14
  %21 = call i64 @_ZN6String4findEPc(ptr nonnull %s4, ptr nonnull @anon.string.12) #2
  %22 = icmp eq i64 %21, 1
...
assert.exit.L16:                                  ; preds = %assert.exit.L15
  %24 = call i64 @_ZN6String4findEPc(ptr nonnull %s4, ptr nonnull @anon.string.14) #2
  %25 = icmp eq i64 %24, -1
...
assert.exit.L17:                                  ; preds = %assert.exit.L16
  %27 = call i64 @_ZN6String4findEPc(ptr nonnull %s4, ptr nonnull @anon.string.16) #2
  %28 = icmp eq i64 %27, 0
...
assert.exit.L18:                                  ; preds = %assert.exit.L17
  %30 = call i64 @_ZN6String4findEPc(ptr nonnull %s4, ptr nonnull @anon.string.18) #2
...
assert.exit.L19:                                  ; preds = %assert.exit.L18
  %33 = call i64 @_ZN6String4findEPcj(ptr nonnull %s4, ptr nonnull @anon.string.20, i32 12) #2
  %34 = icmp eq i64 %33, -1
...
assert.exit.L20:                                  ; preds = %assert.exit.L19
  %36 = call i1 @_ZN6String8containsEPc(ptr nonnull %s4, ptr nonnull @anon.string.22) #2
...
assert.exit.L21:                                  ; preds = %assert.exit.L20
  %38 = call i1 @_ZN6String8containsEPc(ptr nonnull %s4, ptr nonnull @anon.string.30) #2
...
assert.exit.L22:                                  ; preds = %assert.exit.L21
  %40 = call i1 @_ZN6String8containsEPc(ptr nonnull %s4, ptr nonnull @anon.string.34) #2
...
assert.exit.L23:                                  ; preds = %assert.exit.L22
  %42 = call i1 @_ZN6String8containsEPc(ptr nonnull %s4, ptr nonnull @anon.string.28) #2
...
assert.exit.L24:                                  ; preds = %assert.exit.L23
  %44 = call %struct.String @_ZN6String12getSubstringEjl(ptr nonnull %s4, i32 0, i64 5) #2
  ...
  %45 = call ptr @_ZN6String6getRawEv(ptr nonnull %sub) #2
  %46 = call i1 @_Z10isRawEqualPcPc(ptr %45, ptr nonnull @anon.string.30) #2
...
assert.exit.L26:                                  ; preds = %assert.exit.L24
  %48 = call %struct.String @_ZN6String12getSubstringEml(ptr nonnull %s4, i64 4, i64 2) #2
  ...
  %49 = call ptr @_ZN6String6getRawEv(ptr nonnull %sub) #2
  %50 = call i1 @_Z10isRawEqualPcPc(ptr %49, ptr nonnull @anon.string.32) #2
...
assert.exit.L28:                                  ; preds = %assert.exit.L26
  %52 = call %struct.String @_ZN6String12getSubstringEj(ptr nonnull %s4, i32 6) #2
  ...
  %53 = call ptr @_ZN6String6getRawEv(ptr nonnull %sub) #2
  %54 = call i1 @_Z10isRawEqualPcPc(ptr %53, ptr nonnull @anon.string.34) #2
...
assert.exit.L30:                                  ; preds = %assert.exit.L28
  %56 = call %struct.String @_ZN6String12getSubstringEjl(ptr nonnull %s4, i32 2, i64 0) #2
  ...
  %57 = call ptr @_ZN6String6getRawEv(ptr nonnull %sub) #2
  %58 = call i1 @_Z10isRawEqualPcPc(ptr %57, ptr nonnull @anon.string.36) #2
...
assert.exit.L32:                                  ; preds = %assert.exit.L30
  %60 = call %struct.String @_ZN6String12getSubstringEml(ptr nonnull %s4, i64 2, i64 12) #2
  ...
  %61 = call ptr @_ZN6String6getRawEv(ptr nonnull %sub) #2
  %62 = call i1 @_Z10isRawEqualPcPc(ptr %61, ptr nonnull @anon.string.38) #2
...
assert.exit.L34:                                  ; preds = %assert.exit.L32
  ...
  call void @_ZN6String4dtorEv(ptr nonnull %sub) #2
