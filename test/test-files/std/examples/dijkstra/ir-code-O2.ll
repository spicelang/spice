...
for.body.L29:
  ...
  br label %for.body.L37

for.body.L37:                                     ; preds = %for.body.L29, %for.tail.L40.8
  %2 = phi i32 [ %1, %for.body.L29 ], [ %107, %for.tail.L40.8 ]
  %3 = phi i1 [ false, %for.body.L29 ], [ %101, %for.tail.L40.8 ]
  %4 = phi i32 [ %1, %for.body.L29 ], [ %100, %for.tail.L40.8 ]
  %5 = phi i1 [ false, %for.body.L29 ], [ %94, %for.tail.L40.8 ]
  %6 = phi i32 [ %1, %for.body.L29 ], [ %93, %for.tail.L40.8 ]
  %7 = phi i1 [ false, %for.body.L29 ], [ %87, %for.tail.L40.8 ]
  %8 = phi i32 [ %1, %for.body.L29 ], [ %86, %for.tail.L40.8 ]
  %9 = phi i1 [ false, %for.body.L29 ], [ %80, %for.tail.L40.8 ]
  %10 = phi i32 [ %1, %for.body.L29 ], [ %79, %for.tail.L40.8 ]
  %11 = phi i1 [ false, %for.body.L29 ], [ %73, %for.tail.L40.8 ]
  %12 = phi i32 [ %1, %for.body.L29 ], [ %72, %for.tail.L40.8 ]
  %13 = phi i1 [ false, %for.body.L29 ], [ %66, %for.tail.L40.8 ]
  %14 = phi i32 [ %1, %for.body.L29 ], [ %65, %for.tail.L40.8 ]
  %15 = phi i1 [ false, %for.body.L29 ], [ %59, %for.tail.L40.8 ]
  %16 = phi i32 [ %1, %for.body.L29 ], [ %58, %for.tail.L40.8 ]
  %17 = phi i1 [ false, %for.body.L29 ], [ %52, %for.tail.L40.8 ]
  %18 = phi i32 [ 0, %for.body.L29 ], [ %51, %for.tail.L40.8 ]
  %19 = phi i1 [ false, %for.body.L29 ], [ %45, %for.tail.L40.8 ]
  %count.04 = phi i32 [ 0, %for.body.L29 ], [ %108, %for.tail.L40.8 ]
  ...
  br i1 %45, label %for.tail.L40, label %land.1.L41C17

land.1.L41C17:                                    ; preds = %for.body.L37
  %46 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 0
  %47 = load i32, ptr %46, align 4
  %.not = icmp eq i32 %47, 0
  br i1 %.not, label %for.tail.L40, label %land.2.L41C17

land.2.L41C17:                                    ; preds = %land.1.L41C17
  %48 = load i32, ptr %44, align 4
  %.not1 = icmp eq i32 %48, %1
  br i1 %.not1, label %for.tail.L40, label %land.3.L41C17

land.3.L41C17:                                    ; preds = %land.2.L41C17
  %49 = add i32 %48, %47
  %50 = tail call i32 @llvm.smin.i32(i32 %49, i32 %18)
  store i32 %50, ptr %dist, align 4
  br label %for.tail.L40

for.tail.L40:                                     ; preds = %land.3.L41C17, %for.body.L37, %land.1.L41C17, %land.2.L41C17
  %51 = phi i32 [ %50, %land.3.L41C17 ], [ %18, %for.body.L37 ], [ %18, %land.1.L41C17 ], [ %18, %land.2.L41C17 ]
  %52 = load i1, ptr %.fca.1.gep, align 1
  br i1 %52, label %for.tail.L40.1, label %land.1.L41C17.1

land.1.L41C17.1:                                  ; preds = %for.tail.L40
  %53 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 1
  %54 = load i32, ptr %53, align 4
  %.not.1 = icmp eq i32 %54, 0
  br i1 %.not.1, label %for.tail.L40.1, label %land.2.L41C17.1

land.2.L41C17.1:                                  ; preds = %land.1.L41C17.1
  %55 = load i32, ptr %44, align 4
  %.not1.1 = icmp eq i32 %55, %1
  br i1 %.not1.1, label %for.tail.L40.1, label %land.3.L41C17.1

land.3.L41C17.1:                                  ; preds = %land.2.L41C17.1
  %56 = add i32 %55, %54
  %57 = tail call i32 @llvm.smin.i32(i32 %56, i32 %16)
  store i32 %57, ptr %.fca.1.gep19, align 4
  br label %for.tail.L40.1

for.tail.L40.1:                                   ; preds = %land.3.L41C17.1, %land.2.L41C17.1, %land.1.L41C17.1, %for.tail.L40
  %58 = phi i32 [ %57, %land.3.L41C17.1 ], [ %16, %land.2.L41C17.1 ], [ %16, %land.1.L41C17.1 ], [ %16, %for.tail.L40 ]
  %59 = load i1, ptr %.fca.2.gep, align 1
  br i1 %59, label %for.tail.L40.2, label %land.1.L41C17.2

land.1.L41C17.2:                                  ; preds = %for.tail.L40.1
  %60 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 2
  %61 = load i32, ptr %60, align 4
  %.not.2 = icmp eq i32 %61, 0
  br i1 %.not.2, label %for.tail.L40.2, label %land.2.L41C17.2

land.2.L41C17.2:                                  ; preds = %land.1.L41C17.2
  %62 = load i32, ptr %44, align 4
  %.not1.2 = icmp eq i32 %62, %1
  br i1 %.not1.2, label %for.tail.L40.2, label %land.3.L41C17.2

land.3.L41C17.2:                                  ; preds = %land.2.L41C17.2
  %63 = add i32 %62, %61
  %64 = tail call i32 @llvm.smin.i32(i32 %63, i32 %14)
  store i32 %64, ptr %.fca.2.gep20, align 4
  br label %for.tail.L40.2

for.tail.L40.2:                                   ; preds = %land.3.L41C17.2, %land.2.L41C17.2, %land.1.L41C17.2, %for.tail.L40.1
  %65 = phi i32 [ %64, %land.3.L41C17.2 ], [ %14, %land.2.L41C17.2 ], [ %14, %land.1.L41C17.2 ], [ %14, %for.tail.L40.1 ]
  %66 = load i1, ptr %.fca.3.gep, align 1
  br i1 %66, label %for.tail.L40.3, label %land.1.L41C17.3

land.1.L41C17.3:                                  ; preds = %for.tail.L40.2
  %67 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 3
  %68 = load i32, ptr %67, align 4
  %.not.3 = icmp eq i32 %68, 0
  br i1 %.not.3, label %for.tail.L40.3, label %land.2.L41C17.3

land.2.L41C17.3:                                  ; preds = %land.1.L41C17.3
  %69 = load i32, ptr %44, align 4
  %.not1.3 = icmp eq i32 %69, %1
  br i1 %.not1.3, label %for.tail.L40.3, label %land.3.L41C17.3

land.3.L41C17.3:                                  ; preds = %land.2.L41C17.3
  %70 = add i32 %69, %68
  %71 = tail call i32 @llvm.smin.i32(i32 %70, i32 %12)
  store i32 %71, ptr %.fca.3.gep21, align 4
  br label %for.tail.L40.3

for.tail.L40.3:                                   ; preds = %land.3.L41C17.3, %land.2.L41C17.3, %land.1.L41C17.3, %for.tail.L40.2
  %72 = phi i32 [ %71, %land.3.L41C17.3 ], [ %12, %land.2.L41C17.3 ], [ %12, %land.1.L41C17.3 ], [ %12, %for.tail.L40.2 ]
  %73 = load i1, ptr %.fca.4.gep, align 1
  br i1 %73, label %for.tail.L40.4, label %land.1.L41C17.4

land.1.L41C17.4:                                  ; preds = %for.tail.L40.3
  %74 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 4
  %75 = load i32, ptr %74, align 4
  %.not.4 = icmp eq i32 %75, 0
  br i1 %.not.4, label %for.tail.L40.4, label %land.2.L41C17.4

land.2.L41C17.4:                                  ; preds = %land.1.L41C17.4
  %76 = load i32, ptr %44, align 4
  %.not1.4 = icmp eq i32 %76, %1
  br i1 %.not1.4, label %for.tail.L40.4, label %land.3.L41C17.4

land.3.L41C17.4:                                  ; preds = %land.2.L41C17.4
  %77 = add i32 %76, %75
  %78 = tail call i32 @llvm.smin.i32(i32 %77, i32 %10)
  store i32 %78, ptr %.fca.4.gep22, align 4
  br label %for.tail.L40.4

for.tail.L40.4:                                   ; preds = %land.3.L41C17.4, %land.2.L41C17.4, %land.1.L41C17.4, %for.tail.L40.3
  %79 = phi i32 [ %78, %land.3.L41C17.4 ], [ %10, %land.2.L41C17.4 ], [ %10, %land.1.L41C17.4 ], [ %10, %for.tail.L40.3 ]
  %80 = load i1, ptr %.fca.5.gep, align 1
  br i1 %80, label %for.tail.L40.5, label %land.1.L41C17.5

land.1.L41C17.5:                                  ; preds = %for.tail.L40.4
  %81 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 5
  %82 = load i32, ptr %81, align 4
  %.not.5 = icmp eq i32 %82, 0
  br i1 %.not.5, label %for.tail.L40.5, label %land.2.L41C17.5

land.2.L41C17.5:                                  ; preds = %land.1.L41C17.5
  %83 = load i32, ptr %44, align 4
  %.not1.5 = icmp eq i32 %83, %1
  br i1 %.not1.5, label %for.tail.L40.5, label %land.3.L41C17.5

land.3.L41C17.5:                                  ; preds = %land.2.L41C17.5
  %84 = add i32 %83, %82
  %85 = tail call i32 @llvm.smin.i32(i32 %84, i32 %8)
  store i32 %85, ptr %.fca.5.gep23, align 4
  br label %for.tail.L40.5

for.tail.L40.5:                                   ; preds = %land.3.L41C17.5, %land.2.L41C17.5, %land.1.L41C17.5, %for.tail.L40.4
  %86 = phi i32 [ %85, %land.3.L41C17.5 ], [ %8, %land.2.L41C17.5 ], [ %8, %land.1.L41C17.5 ], [ %8, %for.tail.L40.4 ]
  %87 = load i1, ptr %.fca.6.gep, align 1
  br i1 %87, label %for.tail.L40.6, label %land.1.L41C17.6

land.1.L41C17.6:                                  ; preds = %for.tail.L40.5
  %88 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 6
  %89 = load i32, ptr %88, align 4
  %.not.6 = icmp eq i32 %89, 0
  br i1 %.not.6, label %for.tail.L40.6, label %land.2.L41C17.6

land.2.L41C17.6:                                  ; preds = %land.1.L41C17.6
  %90 = load i32, ptr %44, align 4
  %.not1.6 = icmp eq i32 %90, %1
  br i1 %.not1.6, label %for.tail.L40.6, label %land.3.L41C17.6

land.3.L41C17.6:                                  ; preds = %land.2.L41C17.6
  %91 = add i32 %90, %89
  %92 = tail call i32 @llvm.smin.i32(i32 %91, i32 %6)
  store i32 %92, ptr %.fca.6.gep24, align 4
  br label %for.tail.L40.6

for.tail.L40.6:                                   ; preds = %land.3.L41C17.6, %land.2.L41C17.6, %land.1.L41C17.6, %for.tail.L40.5
  %93 = phi i32 [ %92, %land.3.L41C17.6 ], [ %6, %land.2.L41C17.6 ], [ %6, %land.1.L41C17.6 ], [ %6, %for.tail.L40.5 ]
  %94 = load i1, ptr %.fca.7.gep, align 1
  br i1 %94, label %for.tail.L40.7, label %land.1.L41C17.7

land.1.L41C17.7:                                  ; preds = %for.tail.L40.6
  %95 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 7
  %96 = load i32, ptr %95, align 4
  %.not.7 = icmp eq i32 %96, 0
  br i1 %.not.7, label %for.tail.L40.7, label %land.2.L41C17.7

land.2.L41C17.7:                                  ; preds = %land.1.L41C17.7
  %97 = load i32, ptr %44, align 4
  %.not1.7 = icmp eq i32 %97, %1
  br i1 %.not1.7, label %for.tail.L40.7, label %land.3.L41C17.7

land.3.L41C17.7:                                  ; preds = %land.2.L41C17.7
  %98 = add i32 %97, %96
  %99 = tail call i32 @llvm.smin.i32(i32 %98, i32 %4)
  store i32 %99, ptr %.fca.7.gep25, align 4
  br label %for.tail.L40.7

for.tail.L40.7:                                   ; preds = %land.3.L41C17.7, %land.2.L41C17.7, %land.1.L41C17.7, %for.tail.L40.6
  %100 = phi i32 [ %99, %land.3.L41C17.7 ], [ %4, %land.2.L41C17.7 ], [ %4, %land.1.L41C17.7 ], [ %4, %for.tail.L40.6 ]
  %101 = load i1, ptr %.fca.8.gep, align 1
  br i1 %101, label %for.tail.L40.8, label %land.1.L41C17.8

land.1.L41C17.8:                                  ; preds = %for.tail.L40.7
  %102 = getelementptr inbounds [9 x i32], ptr %0, i64 %42, i64 8
  %103 = load i32, ptr %102, align 4
  %.not.8 = icmp eq i32 %103, 0
  br i1 %.not.8, label %for.tail.L40.8, label %land.2.L41C17.8

land.2.L41C17.8:                                  ; preds = %land.1.L41C17.8
  %104 = load i32, ptr %44, align 4
  %.not1.8 = icmp eq i32 %104, %1
  br i1 %.not1.8, label %for.tail.L40.8, label %land.3.L41C17.8

land.3.L41C17.8:                                  ; preds = %land.2.L41C17.8
  %105 = add i32 %104, %103
  %106 = tail call i32 @llvm.smin.i32(i32 %105, i32 %2)
  store i32 %106, ptr %.fca.8.gep26, align 4
  br label %for.tail.L40.8

for.tail.L40.8:                                   ; preds = %land.3.L41C17.8, %land.2.L41C17.8, %land.1.L41C17.8, %for.tail.L40.7
  %107 = phi i32 [ %106, %land.3.L41C17.8 ], [ %2, %land.2.L41C17.8 ], [ %2, %land.1.L41C17.8 ], [ %2, %for.tail.L40.7 ]
  %108 = add nuw nsw i32 %count.04, 1
  %exitcond.not = icmp eq i32 %108, 8
  br i1 %exitcond.not, label %for.exit.L37, label %for.body.L37

for.exit.L37:                                     ; preds = %for.tail.L40.8
