...
@printf.str.8 = private unnamed_addr constant [18 x i8] c"Sin (double): %f\0A\00", align 1
@printf.str.9 = private unnamed_addr constant [15 x i8] c"Sin (int): %f\0A\00", align 1
@printf.str.10 = private unnamed_addr constant [17 x i8] c"Sin (short): %f\0A\00", align 1
@printf.str.11 = private unnamed_addr constant [16 x i8] c"Sin (long): %f\0A\00", align 1
@printf.str.12 = private unnamed_addr constant [18 x i8] c"Cos (double): %f\0A\00", align 1
@printf.str.13 = private unnamed_addr constant [15 x i8] c"Cos (int): %f\0A\00", align 1
@printf.str.14 = private unnamed_addr constant [17 x i8] c"Cos (short): %f\0A\00", align 1
@printf.str.15 = private unnamed_addr constant [16 x i8] c"Cos (long): %f\0A\00", align 1
