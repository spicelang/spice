...
declare i32 @_Z3absi(i32) local_unnamed_addr

declare i16 @_Z3abss(i16) local_unnamed_addr

declare i64 @_Z3absl(i64) local_unnamed_addr

declare double @_Z3absd(double) local_unnamed_addr

declare double @_Z8degToRadd(double) local_unnamed_addr

declare double @_Z8radToDegd(double) local_unnamed_addr

declare double @_Z3sind(double) local_unnamed_addr

declare double @_Z3sini(i32) local_unnamed_addr

declare double @_Z3sins(i16) local_unnamed_addr

declare double @_Z3sinl(i64) local_unnamed_addr

declare double @_Z3cosd(double) local_unnamed_addr

declare double @_Z3cosi(i32) local_unnamed_addr

declare double @_Z3coss(i16) local_unnamed_addr

declare double @_Z3cosl(i64) local_unnamed_addr
