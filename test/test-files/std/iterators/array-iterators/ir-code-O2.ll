...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %it = alloca %__int__ArrayIterator__intptr_long_long, align 8
  %pair = alloca %__long_intref__Pair__long_intref, align 8
  %1 = alloca %__int__ArrayIterator__intptr_long_long, align 8
  ...
  %4 = call %__int__ArrayIterator__intptr_long_long @"_f__void__std/iterator/array-iterator::ArrayIterator<int>__iterate__intarray_long"(ptr nonnull %a, i64 5) #2
  %.fca.0.extract24 = extractvalue %__int__ArrayIterator__intptr_long_long %4, 0
  %.fca.1.extract26 = extractvalue %__int__ArrayIterator__intptr_long_long %4, 1
  %.fca.1.gep27 = getelementptr inbounds %__int__ArrayIterator__intptr_long_long, ptr %it, i64 0, i32 1
  %.fca.2.extract28 = extractvalue %__int__ArrayIterator__intptr_long_long %4, 2
  %.fca.2.gep29 = getelementptr inbounds %__int__ArrayIterator__intptr_long_long, ptr %it, i64 0, i32 2
  ...
  %5 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %it) #2
...
assert.exit.L9:                                   ; preds = %0
  %7 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %it) #2
...
assert.exit.L10:                                  ; preds = %assert.exit.L9
  %11 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %it) #2
...
assert.exit.L11:                                  ; preds = %assert.exit.L10
  call void @_mp__ArrayIterator_int__void__next(ptr nonnull %it) #2
  %15 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %it) #2
...
assert.exit.L13:                                  ; preds = %assert.exit.L11
  %19 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %it) #2
...
assert.exit.L14:                                  ; preds = %assert.exit.L13
  call void @_mp__ArrayIterator_int__void__next(ptr nonnull %it) #2
  %21 = call %__long_intref__Pair__long_intref @"_mf__ArrayIterator_int__std/iterator/iterable::Pair<unsigned long,int&>__getIdx"(ptr nonnull %it) #2
  %.fca.0.extract16 = extractvalue %__long_intref__Pair__long_intref %21, 0
  %.fca.1.extract18 = extractvalue %__long_intref__Pair__long_intref %21, 1
  %.fca.1.gep19 = getelementptr inbounds %__long_intref__Pair__long_intref, ptr %pair, i64 0, i32 1
  store i64 %.fca.0.extract16, ptr %pair, align 8
  store ptr %.fca.1.extract18, ptr %.fca.1.gep19, align 8
  %22 = call ptr @_mf__Pair_long_intref__longref__getFirst(ptr nonnull %pair) #2
...
assert.exit.L17:                                  ; preds = %assert.exit.L14
  %26 = call ptr @_mf__Pair_long_intref__intref__getSecond(ptr nonnull %pair) #2
...
assert.exit.L18:                                  ; preds = %assert.exit.L17
  call void @_mp__ArrayIterator_int__void__next(ptr nonnull %it) #2
  call void @"_p__void__void__op.minusequal__ArrayIterator<int>ref_int"(ptr nonnull %it, i32 3) #2
  %30 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %it) #2
...
assert.exit.L23:                                  ; preds = %assert.exit.L18
  %34 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %it) #2
...
assert.exit.L24:                                  ; preds = %assert.exit.L23
  call void @"_p__void__void__op.plusplus.post__ArrayIterator<int>ref"(ptr nonnull %it) #2
  %36 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %it) #2
...
assert.exit.L26:                                  ; preds = %assert.exit.L24
  call void @"_p__void__void__op.minusminus.post__ArrayIterator<int>ref"(ptr nonnull %it) #2
  %40 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %it) #2
...
assert.exit.L28:                                  ; preds = %assert.exit.L26
  call void @"_p__void__void__op.plusequal__ArrayIterator<int>ref_int"(ptr nonnull %it, i32 4) #2
  %44 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %it) #2
...
assert.exit.L30:                                  ; preds = %assert.exit.L28
  call void @_mp__ArrayIterator_int__void__next(ptr nonnull %it) #2
  %48 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %it) #2
...
assert.exit.L32:                                  ; preds = %assert.exit.L30
  %50 = call %__int__ArrayIterator__intptr_long_long @"_f__void__std/iterator/array-iterator::ArrayIterator<int>__iterate__intarray_long"(ptr nonnull %a, i64 5) #2
  %.fca.0.extract10 = extractvalue %__int__ArrayIterator__intptr_long_long %50, 0
  store ptr %.fca.0.extract10, ptr %1, align 8
  %.fca.1.extract12 = extractvalue %__int__ArrayIterator__intptr_long_long %50, 1
  %.fca.1.gep13 = getelementptr inbounds %__int__ArrayIterator__intptr_long_long, ptr %1, i64 0, i32 1
  store i64 %.fca.1.extract12, ptr %.fca.1.gep13, align 8
  %.fca.2.extract14 = extractvalue %__int__ArrayIterator__intptr_long_long %50, 2
  %.fca.2.gep15 = getelementptr inbounds %__int__ArrayIterator__intptr_long_long, ptr %1, i64 0, i32 2
  store i64 %.fca.2.extract14, ptr %.fca.2.gep15, align 8
  %51 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %1) #2
  br i1 %51, label %foreach.body.L35, label %foreach.exit.L35

foreach.body.L35:                                 ; preds = %assert.exit.L32, %foreach.body.L35
  %52 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %1) #2
  call void @_mp__ArrayIterator_int__void__next(ptr nonnull %1) #2
  %53 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %1) #2
...
assert.exit.L40:                                  ; preds = %assert.exit.L39
  %63 = call %__int__ArrayIterator__intptr_long_long @"_f__void__std/iterator/array-iterator::ArrayIterator<int>__iterate__intarray_long"(ptr nonnull %a, i64 5) #2
  %.fca.0.extract4 = extractvalue %__int__ArrayIterator__intptr_long_long %63, 0
  store ptr %.fca.0.extract4, ptr %2, align 8
  %.fca.1.extract6 = extractvalue %__int__ArrayIterator__intptr_long_long %63, 1
  %.fca.1.gep7 = getelementptr inbounds %__int__ArrayIterator__intptr_long_long, ptr %2, i64 0, i32 1
  store i64 %.fca.1.extract6, ptr %.fca.1.gep7, align 8
  %.fca.2.extract8 = extractvalue %__int__ArrayIterator__intptr_long_long %63, 2
  %.fca.2.gep9 = getelementptr inbounds %__int__ArrayIterator__intptr_long_long, ptr %2, i64 0, i32 2
  store i64 %.fca.2.extract8, ptr %.fca.2.gep9, align 8
  %64 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %2) #2
  br i1 %64, label %foreach.body.L43, label %foreach.exit.L43

foreach.body.L43:                                 ; preds = %assert.exit.L40, %foreach.body.L43
  %65 = call ptr @_mf__ArrayIterator_int__intref__get(ptr nonnull %2) #2
  %66 = load i32, ptr %65, align 4
  %67 = add i32 %66, 1
  store i32 %67, ptr %65, align 4
  call void @_mp__ArrayIterator_int__void__next(ptr nonnull %2) #2
  %68 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %2) #2
...
assert.exit.L48:                                  ; preds = %assert.exit.L47
  %78 = call %__int__ArrayIterator__intptr_long_long @"_f__void__std/iterator/array-iterator::ArrayIterator<int>__iterate__intarray_long"(ptr nonnull %a, i64 5) #2
  %.fca.0.extract = extractvalue %__int__ArrayIterator__intptr_long_long %78, 0
  store ptr %.fca.0.extract, ptr %3, align 8
  %.fca.1.extract = extractvalue %__int__ArrayIterator__intptr_long_long %78, 1
  %.fca.1.gep = getelementptr inbounds %__int__ArrayIterator__intptr_long_long, ptr %3, i64 0, i32 1
  store i64 %.fca.1.extract, ptr %.fca.1.gep, align 8
  %.fca.2.extract = extractvalue %__int__ArrayIterator__intptr_long_long %78, 2
  %.fca.2.gep = getelementptr inbounds %__int__ArrayIterator__intptr_long_long, ptr %3, i64 0, i32 2
  store i64 %.fca.2.extract, ptr %.fca.2.gep, align 8
  %79 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %3) #2
  br i1 %79, label %foreach.body.L50, label %foreach.exit.L50

foreach.body.L50:                                 ; preds = %assert.exit.L48, %foreach.body.L50
  %pair3 = call %__long_intref__Pair__long_intref @"_mf__ArrayIterator_int__std/iterator/iterable::Pair<unsigned long,int&>__getIdx"(ptr nonnull %3) #2
  ...
  call void @_mp__ArrayIterator_int__void__next(ptr nonnull %3) #2
  %83 = call i1 @_mf__ArrayIterator_int__bool__isValid(ptr nonnull %3) #2
...
declare %__int__ArrayIterator__intptr_long_long @"_f__void__std/iterator/array-iterator::ArrayIterator<int>__iterate__intarray_long"(ptr, i64) local_unnamed_addr

declare i1 @_mf__ArrayIterator_int__bool__isValid(ptr) local_unnamed_addr
...
declare ptr @_mf__ArrayIterator_int__intref__get(ptr) local_unnamed_addr

declare void @_mp__ArrayIterator_int__void__next(ptr) local_unnamed_addr

declare %__long_intref__Pair__long_intref @"_mf__ArrayIterator_int__std/iterator/iterable::Pair<unsigned long,int&>__getIdx"(ptr) local_unnamed_addr
...
declare void @"_p__void__void__op.minusequal__ArrayIterator<int>ref_int"(ptr, i32) local_unnamed_addr

declare void @"_p__void__void__op.plusplus.post__ArrayIterator<int>ref"(ptr) local_unnamed_addr

declare void @"_p__void__void__op.minusminus.post__ArrayIterator<int>ref"(ptr) local_unnamed_addr

declare void @"_p__void__void__op.plusequal__ArrayIterator<int>ref_int"(ptr, i32) local_unnamed_addr
