...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @_ZN6VectorIiE4ctorEv(ptr nonnull %vi) #2
  store i32 123, ptr %1, align 4
  call void @_ZN6VectorIiE8pushBackERKi(ptr nonnull %vi, ptr nonnull %1) #2
  store i32 4321, ptr %2, align 4
  call void @_ZN6VectorIiE8pushBackERKi(ptr nonnull %vi, ptr nonnull %2) #2
  store i32 9876, ptr %3, align 4
  call void @_ZN6VectorIiE8pushBackERKi(ptr nonnull %vi, ptr nonnull %3) #2
  %9 = call i64 @_ZN6VectorIiE7getSizeEv(ptr nonnull %vi) #2
  %10 = icmp eq i64 %9, 3
...
assert.exit.L9:                                   ; preds = %0
  ...
  %13 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %it) #2
...
assert.exit.L13:                                  ; preds = %assert.exit.L9
  %15 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr nonnull %it) #2
...
assert.exit.L14:                                  ; preds = %assert.exit.L13
  %19 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr nonnull %it) #2
...
assert.exit.L15:                                  ; preds = %assert.exit.L14
  call void @_ZN14VectorIteratorIiE4nextEv(ptr nonnull %it) #2
  %23 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr nonnull %it) #2
...
assert.exit.L17:                                  ; preds = %assert.exit.L15
  %27 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %it) #2
...
assert.exit.L18:                                  ; preds = %assert.exit.L17
  call void @_ZN14VectorIteratorIiE4nextEv(ptr nonnull %it) #2
  %29 = call %struct.Pair @_ZN14VectorIteratorIiE6getIdxEv(ptr nonnull %it) #2
  ...
  %30 = call ptr @_ZN4PairImRiE8getFirstEv(ptr nonnull %pair) #2
...
assert.exit.L21:                                  ; preds = %assert.exit.L18
  %34 = call ptr @_ZN4PairImRiE9getSecondEv(ptr nonnull %pair) #2
...
assert.exit.L22:                                  ; preds = %assert.exit.L21
  call void @_ZN14VectorIteratorIiE4nextEv(ptr nonnull %it) #2
  %38 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %it) #2
...
assert.exit.L24:                                  ; preds = %assert.exit.L22
  ...
  call void @_ZN6VectorIiE8pushBackERKi(ptr nonnull %vi, ptr nonnull %4) #2
  store i32 -99, ptr %5, align 4
  call void @_ZN6VectorIiE8pushBackERKi(ptr nonnull %vi, ptr nonnull %5) #2
  %40 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %it) #2
...
assert.exit.L33:                                  ; preds = %assert.exit.L29
  %46 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %it) #2
...
assert.exit.L40:                                  ; preds = %assert.exit.L38
  call void @_ZN14VectorIteratorIiE4nextEv(ptr nonnull %it) #2
  %60 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %it) #2
...
assert.exit.L42:                                  ; preds = %assert.exit.L40
  ...
  %63 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %6) #2
  br i1 %63, label %foreach.body.L45, label %foreach.exit.L45

foreach.body.L45:                                 ; preds = %assert.exit.L42, %foreach.body.L45
  %64 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr nonnull %6) #2
  call void @_ZN14VectorIteratorIiE4nextEv(ptr nonnull %6) #2
  %65 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %6) #2
  br i1 %65, label %foreach.body.L45, label %foreach.exit.L45

foreach.exit.L45:                                 ; preds = %foreach.body.L45, %assert.exit.L42
  %66 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 0) #2
...
assert.exit.L48:                                  ; preds = %foreach.exit.L45
  %70 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 1) #2
...
assert.exit.L49:                                  ; preds = %assert.exit.L48
  %74 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 2) #2
...
assert.exit.L50:                                  ; preds = %assert.exit.L49
  ...
  %79 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %7) #2
  br i1 %79, label %foreach.body.L53, label %foreach.exit.L53

foreach.body.L53:                                 ; preds = %assert.exit.L50, %foreach.body.L53
  %80 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr nonnull %7) #2
  %81 = load i32, ptr %80, align 4
  %82 = add i32 %81, 1
  store i32 %82, ptr %80, align 4
  call void @_ZN14VectorIteratorIiE4nextEv(ptr nonnull %7) #2
  %83 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %7) #2
  br i1 %83, label %foreach.body.L53, label %foreach.exit.L53

foreach.exit.L53:                                 ; preds = %foreach.body.L53, %assert.exit.L50
  %84 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 0) #2
...
assert.exit.L56:                                  ; preds = %foreach.exit.L53
  %88 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 1) #2
...
assert.exit.L57:                                  ; preds = %assert.exit.L56
  %92 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 2) #2
...
assert.exit.L58:                                  ; preds = %assert.exit.L57
  ...
  %97 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %8) #2
  br i1 %97, label %foreach.body.L60, label %foreach.exit.L60

foreach.body.L60:                                 ; preds = %assert.exit.L58, %foreach.body.L60
  %pair3 = call %struct.Pair @_ZN14VectorIteratorIiE6getIdxEv(ptr nonnull %8) #2
  ...
  call void @_ZN14VectorIteratorIiE4nextEv(ptr nonnull %8) #2
  %101 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr nonnull %8) #2
  br i1 %101, label %foreach.body.L60, label %foreach.exit.L60

foreach.exit.L60:                                 ; preds = %foreach.body.L60, %assert.exit.L58
  %102 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 0) #2
...
assert.exit.L63:                                  ; preds = %foreach.exit.L60
  %106 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 1) #2
...
assert.exit.L64:                                  ; preds = %assert.exit.L63
  %110 = call ptr @_ZN6VectorIiE3getEj(ptr nonnull %vi, i32 2) #2
...
assert.exit.L65:                                  ; preds = %assert.exit.L64
  ...
  call void @_ZN6VectorIiE4dtorEv(ptr nonnull %vi) #2
  ret i32 0
}
