...
define dso_local i32 @main() local_unnamed_addr #0 {
  %1 = tail call double @_Z8toDoublel(i64 123) #2
...
assert.exit.L6:                                   ; preds = %0
  %4 = tail call i32 @_Z5toIntl(i64 459873) #2
...
assert.exit.L10:                                  ; preds = %assert.exit.L6
  %7 = tail call i16 @_Z7toShortl(i64 -345) #2
  %8 = icmp eq i16 %7, -345
...
assert.exit.L14:                                  ; preds = %assert.exit.L10
  %10 = tail call i8 @_Z6toBytel(i64 12) #2
  %11 = icmp eq i8 %10, 12
...
assert.exit.L18:                                  ; preds = %assert.exit.L14
  %13 = tail call i8 @_Z6toCharl(i64 66) #2
  %14 = icmp eq i8 %13, 66
...
assert.exit.L22:                                  ; preds = %assert.exit.L18
  %16 = tail call i1 @_Z6toBooll(i64 1) #2
...
assert.exit.L31:                                  ; preds = %assert.exit.L22
  %18 = tail call i1 @_Z6toBooll(i64 0) #2
...
assert.exit.L33:                                  ; preds = %assert.exit.L31
  %20 = tail call i1 @_Z12isPowerOfTwol(i64 16) #2
...
assert.exit.L36:                                  ; preds = %assert.exit.L33
  %22 = tail call i1 @_Z12isPowerOfTwol(i64 31) #2
