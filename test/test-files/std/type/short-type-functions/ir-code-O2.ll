...
define dso_local i32 @main() local_unnamed_addr #0 {
  %1 = tail call double @_Z8toDoubles(i16 123) #2
...
assert.exit.L6:                                   ; preds = %0
  %4 = tail call i32 @_Z5toInts(i16 -345) #2
  %5 = icmp eq i32 %4, -345
...
assert.exit.L10:                                  ; preds = %assert.exit.L6
  %7 = tail call i64 @_Z6toLongs(i16 45) #2
  %8 = icmp eq i64 %7, 45
...
assert.exit.L14:                                  ; preds = %assert.exit.L10
  %10 = tail call i8 @_Z6toBytes(i16 12) #2
  %11 = icmp eq i8 %10, 12
...
assert.exit.L18:                                  ; preds = %assert.exit.L14
  %13 = tail call i8 @_Z6toChars(i16 66) #2
  %14 = icmp eq i8 %13, 66
...
assert.exit.L22:                                  ; preds = %assert.exit.L18
  %16 = tail call i1 @_Z6toBools(i16 1) #2
...
assert.exit.L31:                                  ; preds = %assert.exit.L22
  %18 = tail call i1 @_Z6toBools(i16 0) #2
...
assert.exit.L33:                                  ; preds = %assert.exit.L31
  %20 = tail call i1 @_Z12isPowerOfTwos(i16 16) #2
...
assert.exit.L36:                                  ; preds = %assert.exit.L33
  %22 = tail call i1 @_Z12isPowerOfTwos(i16 31) #2
