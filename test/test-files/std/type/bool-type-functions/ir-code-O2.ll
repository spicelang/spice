...
define dso_local i32 @main() local_unnamed_addr #0 {
  %1 = tail call double @_f__void__double__toDouble__bool(i1 true) #2
...
assert.exit.L6:                                   ; preds = %0
  %4 = tail call double @_f__void__double__toDouble__bool(i1 false) #2
  %5 = fcmp oeq double %4, 0.000000e+00
  br i1 %5, label %assert.exit.L8, label %assert.then.L8
...
assert.exit.L8:                                   ; preds = %assert.exit.L6
  %7 = tail call i32 @_f__void__int__toInt__bool(i1 true) #2
  %8 = icmp eq i32 %7, 1
  br i1 %8, label %assert.exit.L12, label %assert.then.L12
...
assert.exit.L12:                                  ; preds = %assert.exit.L8
  %10 = tail call i32 @_f__void__int__toInt__bool(i1 false) #2
  %11 = icmp eq i32 %10, 0
  br i1 %11, label %assert.exit.L14, label %assert.then.L14
...
assert.exit.L14:                                  ; preds = %assert.exit.L12
  %13 = tail call i16 @_f__void__short__toShort__bool(i1 true) #2
  %14 = icmp eq i16 %13, 1
  br i1 %14, label %assert.exit.L18, label %assert.then.L18
...
assert.exit.L18:                                  ; preds = %assert.exit.L14
  %16 = tail call i16 @_f__void__short__toShort__bool(i1 false) #2
  %17 = icmp eq i16 %16, 0
  br i1 %17, label %assert.exit.L20, label %assert.then.L20

assert.then.L20:                                  ; preds = %assert.exit.L18
  %18 = tail call i32 (ptr, ...) @printf(ptr nonnull @anon.string.5)
  tail call void @exit(i32 1) #2
  unreachable

assert.exit.L20:                                  ; preds = %assert.exit.L18
  %19 = tail call i64 @_f__void__long__toLong__bool(i1 true) #2
  %20 = icmp eq i64 %19, 1
  br i1 %20, label %assert.exit.L24, label %assert.then.L24

assert.then.L24:                                  ; preds = %assert.exit.L20
  %21 = tail call i32 (ptr, ...) @printf(ptr nonnull @anon.string.6)
  tail call void @exit(i32 1) #2
  unreachable

assert.exit.L24:                                  ; preds = %assert.exit.L20
  %22 = tail call i64 @_f__void__long__toLong__bool(i1 false) #2
  %23 = icmp eq i64 %22, 0
  br i1 %23, label %assert.exit.L26, label %assert.then.L26

assert.then.L26:                                  ; preds = %assert.exit.L24
  %24 = tail call i32 (ptr, ...) @printf(ptr nonnull @anon.string.7)
  tail call void @exit(i32 1) #2
  unreachable

assert.exit.L26:                                  ; preds = %assert.exit.L24
  %25 = tail call i8 @_f__void__byte__toByte__bool(i1 true) #2
  %26 = icmp eq i8 %25, 1
  br i1 %26, label %assert.exit.L30, label %assert.then.L30

assert.then.L30:                                  ; preds = %assert.exit.L26
  %27 = tail call i32 (ptr, ...) @printf(ptr nonnull @anon.string.8)
  tail call void @exit(i32 1) #2
  unreachable

assert.exit.L30:                                  ; preds = %assert.exit.L26
  %28 = tail call i8 @_f__void__byte__toByte__bool(i1 false) #2
  %29 = icmp eq i8 %28, 0
  br i1 %29, label %assert.exit.L32, label %assert.then.L32

assert.then.L32:                                  ; preds = %assert.exit.L30
  %30 = tail call i32 (ptr, ...) @printf(ptr nonnull @anon.string.9)
  tail call void @exit(i32 1) #2
  unreachable

assert.exit.L32:                                  ; preds = %assert.exit.L30
  %31 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull @printf.str.0)
  ret i32 0
}

declare double @_f__void__double__toDouble__bool(i1) local_unnamed_addr
...
declare i32 @_f__void__int__toInt__bool(i1) local_unnamed_addr

declare i16 @_f__void__short__toShort__bool(i1) local_unnamed_addr

declare i64 @_f__void__long__toLong__bool(i1) local_unnamed_addr

declare i8 @_f__void__byte__toByte__bool(i1) local_unnamed_addr
