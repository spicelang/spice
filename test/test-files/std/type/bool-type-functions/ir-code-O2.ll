...
define dso_local i32 @main() local_unnamed_addr #0 {
  %1 = tail call double @_Z8toDoubleb(i1 true) #3
...
assert.exit.L6:                                   ; preds = %0
  %4 = tail call double @_Z8toDoubleb(i1 false) #3
...
assert.exit.L8:                                   ; preds = %assert.exit.L6
  %7 = tail call i32 @_Z5toIntb(i1 true) #3
  %8 = icmp eq i32 %7, 1
...
assert.exit.L12:                                  ; preds = %assert.exit.L8
  %10 = tail call i32 @_Z5toIntb(i1 false) #3
  %11 = icmp eq i32 %10, 0
...
assert.exit.L14:                                  ; preds = %assert.exit.L12
  %13 = tail call i16 @_Z7toShortb(i1 true) #3
  %14 = icmp eq i16 %13, 1
...
assert.exit.L18:                                  ; preds = %assert.exit.L14
  %16 = tail call i16 @_Z7toShortb(i1 false) #3
  %17 = icmp eq i16 %16, 0
...
assert.exit.L20:                                  ; preds = %assert.exit.L18
  %19 = tail call i64 @_Z6toLongb(i1 true) #3
  %20 = icmp eq i64 %19, 1
...
assert.exit.L24:                                  ; preds = %assert.exit.L20
  %22 = tail call i64 @_Z6toLongb(i1 false) #3
  %23 = icmp eq i64 %22, 0
...
assert.exit.L26:                                  ; preds = %assert.exit.L24
  %25 = tail call i8 @_Z6toByteb(i1 true) #3
  %26 = icmp eq i8 %25, 1
...
assert.exit.L30:                                  ; preds = %assert.exit.L26
  %28 = tail call i8 @_Z6toByteb(i1 false) #3
  %29 = icmp eq i8 %28, 0
