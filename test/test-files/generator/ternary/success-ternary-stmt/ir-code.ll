...
entry:
  ...
  store i1 %3, i1* %condition, align 1
  %4 = call i32 @_f__void__get()
  store i32 %4, i32* %1, align 4
  store i32 24, i32* %2, align 4
  %5 = load i1, i1* %condition, align 1
  %6 = select i1 %5, i32* %1, i32* %2
  %7 = load i32, i32* %6, align 4
  store i32 %7, i32* %r, align 4
  %8 = load i32, i32* %r, align 4
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @0, i32 0, i32 0), i32 %8)
