...
if.then.l2:                                       ; preds = %tailrecurse.backedge, %entry.l1
  %.tr7.lcssa = phi i32 [ %1, %entry.l1 ], [ %.tr7.be, %tailrecurse.backedge ]
  %3 = add i32 %.tr7.lcssa, 1
  ret i32 %3

if.end.l2:                                        ; preds = %entry.l1, %tailrecurse.backedge
  %.tr79 = phi i32 [ %.tr7.be, %tailrecurse.backedge ], [ %1, %entry.l1 ]
  %.tr8 = phi i32 [ %.tr.be, %tailrecurse.backedge ], [ %0, %entry.l1 ]
  %4 = icmp eq i32 %.tr79, 0
  br i1 %4, label %tailrecurse.backedge, label %if.end.l3

tailrecurse.backedge:                             ; preds = %if.end.l2, %if.end.l3
  %.tr7.be = phi i32 [ %7, %if.end.l3 ], [ 1, %if.end.l2 ]
  %.tr.be = add i32 %.tr8, -1
...
if.end.l3:                                        ; preds = %if.end.l2
  %6 = add i32 %.tr79, -1
  %7 = tail call fastcc i32 @_f__void__ack__int_int(i32 %.tr8, i32 %6)
