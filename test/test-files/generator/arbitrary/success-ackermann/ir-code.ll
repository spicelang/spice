...
define internal i32 @_f_int_ack_int_int(i32 %0, i32 %1) #0 {
entry:
...
if.then1:                                         ; preds = %if.end
  ...
  %35 = call i32 @_f_int_ack_int_int(i32 %33, i32 %34)
...
if.end2:                                          ; preds = %if.end
  ...
  %46 = call i32 @_f_int_ack_int_int(i32 %41, i32 %45)
  store i32 %46, i32* %16, align 4
  %47 = load i32, i32* %16, align 4
  %48 = call i32 @_f_int_ack_int_int(i32 %40, i32 %47)
...
entry:
  ...
  %9 = call i32 @_f_int_ack_int_int(i32 %7, i32 %8)
