...
entry:
  ...
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @0, i32 0, i32 0), i32 %25)
  store i32 32, i32* %2, align 4
  %27 = load i32, i32* %2, align 4
  %28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i32 0, i32 0), i32 %27)
  store i32 16, i32* %3, align 4
  %29 = load i32, i32* %3, align 4
  %30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @2, i32 0, i32 0), i32 %29)
  store i32 64, i32* %4, align 4
  %31 = load i32, i32* %4, align 4
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @3, i32 0, i32 0), i32 %31)
  store i8 13, i8* %5, align 1
  %33 = load i8, i8* %5, align 1
  store i32 8, i32* %6, align 4
  %34 = load i32, i32* %6, align 4
  %35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @4, i32 0, i32 0), i32 %34)
  store i8 65, i8* %7, align 1
  %36 = load i8, i8* %7, align 1
  store i32 8, i32* %8, align 4
  %37 = load i32, i32* %8, align 4
  %38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @5, i32 0, i32 0), i32 %37)
  store i32 64, i32* %9, align 4
  %39 = load i32, i32* %9, align 4
  %40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @6, i32 0, i32 0), i32 %39)
  store i32 1, i32* %10, align 4
  %41 = load i32, i32* %10, align 4
  %42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @8, i32 0, i32 0), i32 %41)
  ...
  %43 = load [7 x i32], [7 x i32]* @anonymous.0, align 4
  store i32 224, i32* %18, align 4
  %44 = load i32, i32* %18, align 4
  %45 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @9, i32 0, i32 0), i32 %44)
  store i32 123, i32* %intVariable, align 4
  %46 = load i32, i32* %intVariable, align 4
  store i32* %intVariable, i32** %19, align 8
  store i32* %intVariable, i32** %19, align 8
  %47 = load i32*, i32** %19, align 8
  store i32 64, i32* %20, align 4
  %48 = load i32, i32* %20, align 4
  %49 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @10, i32 0, i32 0), i32 %48)
  store i32 128, i32* %21, align 4
  %50 = load i32, i32* %21, align 4
  %51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @11, i32 0, i32 0), i32 %50)
