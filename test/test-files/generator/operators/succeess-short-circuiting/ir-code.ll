...
define internal i1 @_f_bool_functionTrue() #0 {
entry:
...
; Function Attrs: nounwind
define internal i1 @_f_bool_functionFalse() #0 {
entry:
  %result = alloca i1, align 1
  %0 = alloca i1, align 1
