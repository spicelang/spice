...
entry:
  ...
  %10 = getelementptr inbounds [5 x i16], [5 x i16]* %shortArray1, i32 0, i32 0
  store i16 1, i16* %10, align 2
  %11 = getelementptr inbounds [5 x i16], [5 x i16]* %shortArray1, i32 0, i32 1
  store i16 %5, i16* %11, align 2
  %12 = getelementptr inbounds [5 x i16], [5 x i16]* %shortArray1, i32 0, i32 2
  store i16 %6, i16* %12, align 2
  %13 = getelementptr inbounds [5 x i16], [5 x i16]* %shortArray1, i32 0, i32 3
  store i16 %9, i16* %13, align 2
  %14 = getelementptr inbounds [5 x i16], [5 x i16]* %shortArray1, i32 0, i32 4
  store i16 0, i16* %14, align 2
  store i32 0, i32* %idx, align 4
  store i16 0, i16* %s, align 2
  %15 = load [5 x i16], [5 x i16]* %shortArray1, align 2
  %16 = load i32, i32* %idx, align 4
  %17 = getelementptr inbounds [5 x i16], [5 x i16]* %shortArray1, i32 0, i32 %16
  %18 = load i16, i16* %17, align 2
  store i16 %18, i16* %s, align 2
  br label %foreach.loop

foreach.loop:                                     ; preds = %foreach.cond9, %entry
...
if.then:                                          ; preds = %foreach.loop
  ...
  store [2 x i64] [i64 1, i64 2], [2 x i64]* %l3, align 8
  %28 = load [2 x i64], [2 x i64]* %l3, align 8
  %29 = load i32, i32* %idx2, align 4
  %30 = getelementptr inbounds [2 x i64], [2 x i64]* %l3, i32 0, i32 %29
  %31 = load i64, i64* %30, align 8
  store i64 %31, i64* %l, align 8
  br label %foreach.loop4

foreach.loop4:                                    ; preds = %foreach.cond, %if.then
  %32 = load i64, i64* %l, align 8
  %33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @1, i32 0, i32 0), i64 %32)
  br label %foreach.end10

foreach.inc:                                      ; No predecessors!
  %idx5 = load i32, i32* %idx2, align 4
  %idx.inc = add i32 %idx5, 1
  store i32 %idx.inc, i32* %idx2, align 4
  %34 = getelementptr inbounds [2 x i64], [2 x i64]* %l3, i32 0, i32 %idx.inc
  %35 = load i64, i64* %34, align 8
  store i64 %35, i64* %l, align 8
  br label %foreach.cond

foreach.cond:                                     ; preds = %foreach.inc
  %36 = load i32, i32* %idx2, align 4
  %37 = icmp ult i32 %36, 2
  br i1 %37, label %foreach.loop4, label %foreach.end

foreach.end:                                      ; preds = %foreach.cond
  br label %if.end

if.end:                                           ; preds = %foreach.end, %foreach.loop
  br label %foreach.inc6

foreach.inc6:                                     ; preds = %if.end
  %idx7 = load i32, i32* %idx, align 4
  %idx.inc8 = add i32 %idx7, 1
  store i32 %idx.inc8, i32* %idx, align 4
  %38 = getelementptr inbounds [5 x i16], [5 x i16]* %shortArray1, i32 0, i32 %idx.inc8
  %39 = load i16, i16* %38, align 2
  store i16 %39, i16* %s, align 2
  br label %foreach.cond9

foreach.cond9:                                    ; preds = %foreach.inc6
  %40 = load i32, i32* %idx, align 4
  %41 = icmp ult i32 %40, 5
  br i1 %41, label %foreach.loop, label %foreach.end10

foreach.end10:                                    ; preds = %foreach.cond9, %foreach.loop4
