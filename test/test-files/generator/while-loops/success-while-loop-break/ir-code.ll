...
while.l3:                                         ; preds = %while.cond.l3
  %7 = load double, ptr %loopCounterOuter, align 8
...
while.l6:                                         ; preds = %while.cond.l6
  ...
  %15 = load i16, ptr %loopCounterInner, align 2
  %16 = sext i16 %15 to i32
  %17 = call i32 (ptr, ...) @printf(ptr @0, double %14, i32 %16)
  %18 = load i16, ptr %loopCounterInner, align 2
  %19 = sub i16 %18, 1
  store i16 %19, ptr %loopCounterInner, align 2
