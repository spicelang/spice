...
@1 = private unnamed_addr constant [13 x i8] c"Test func 2\0A\00", align 1
...
; Function Attrs: nounwind
define internal i32 @_f_testFunc_string(i8* %0) #0 {
entry:
  %param = alloca i8*, align 8
  %result = alloca i32, align 4
  %1 = alloca i32, align 4
  store i8* %0, i8** %param, align 8
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @1, i32 0, i32 0))
