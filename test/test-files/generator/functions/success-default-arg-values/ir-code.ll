...
@3 = private unnamed_addr constant [12 x i8] c"Result: %s\0A\00", align 1

; Function Attrs: nounwind
define internal i8* @_f_getTestString_int_double(i32 %0, double %1) #0 {
entry:
  ...
  store i1 %5, i1* %arg2, align 1
  store double 1.340000e+00, double* %3, align 8
  %6 = load double, double* %3, align 8
  store double %6, double* %arg3, align 8
...
entry:
  ...
  store i8* getelementptr inbounds ([5 x i8], [5 x i8]* @1, i32 0, i32 0), i8** %4, align 8
  %6 = load i8*, i8** %4, align 8
  ret i8* %6
}

; Function Attrs: nounwind
define internal i8* @_f_getTestString_int_double_bool_double(i32 %0, double %1, i1 %2, double %3) #0 {
entry:
  %arg0 = alloca i32, align 4
  %arg1 = alloca double, align 8
  %arg2 = alloca i1, align 1
  ...
  store double %1, double* %arg1, align 8
  store i1 %2, i1* %arg2, align 1
  store double %3, double* %arg3, align 8
  store i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i32 0, i32 0), i8** %4, align 8
...
entry:
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @3, i32 0, i32 0), i8* %8)
