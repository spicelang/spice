...
define dso_local i32 @main() #0 {
  ...
  %f2_addr = getelementptr inbounds %__TestStruct__bool_intref, ptr %ts, i32 0, i32 1
  %3 = load ptr, ptr %f2_addr, align 8
  %4 = load i32, ptr %3, align 4
  %5 = call i32 (ptr, ...) @printf(ptr noundef @printf.str.0, i32 %4)
  %f2_addr1 = getelementptr inbounds %__TestStruct__bool_intref, ptr %ts, i32 0, i32 1
