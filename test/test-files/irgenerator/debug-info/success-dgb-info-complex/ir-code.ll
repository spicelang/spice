...
define dso_local i32 @main(i32 %0, ptr %1) #0 !dbg !15 {
  ...
  %12 = alloca %struct.VectorIterator, align 8
  ...
  %13 = call i64 @_ZN6VectorIiE7getSizeEv(ptr %vi), !dbg !39
...
assert.exit.L9:                                   ; preds = %2
  ...
  store %struct.VectorIterator %16, ptr %it, align 8, !dbg !42
  %17 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %it), !dbg !54
...
assert.exit.L13:                                  ; preds = %assert.exit.L9
  %19 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr %it), !dbg !55
...
assert.exit.L14:                                  ; preds = %assert.exit.L13
  %23 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr %it), !dbg !57
...
assert.exit.L15:                                  ; preds = %assert.exit.L14
  ...
  %27 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr %it), !dbg !60
...
assert.exit.L17:                                  ; preds = %assert.exit.L15
  %31 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %it), !dbg !62
...
assert.exit.L18:                                  ; preds = %assert.exit.L17
  ...
  %33 = call %struct.Pair @_ZN14VectorIteratorIiE6getIdxEv(ptr %it), !dbg !64
  store %struct.Pair %33, ptr %pair, align 8, !dbg !64
  call void @llvm.dbg.declare(metadata ptr %pair, metadata !65, metadata !DIExpression()), !dbg !64
  store %struct.Pair %33, ptr %pair, align 8, !dbg !64
  %34 = call ptr @_ZN4PairImRiE8getFirstEv(ptr %pair), !dbg !70
...
assert.exit.L21:                                  ; preds = %assert.exit.L18
  %38 = call ptr @_ZN4PairImRiE9getSecondEv(ptr %pair), !dbg !72
...
assert.exit.L22:                                  ; preds = %assert.exit.L21
  ...
  %42 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %it), !dbg !75
...
assert.exit.L24:                                  ; preds = %assert.exit.L22
  ...
  %45 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %it), !dbg !78
...
assert.exit.L33:                                  ; preds = %assert.exit.L29
  %51 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %it), !dbg !82
...
assert.exit.L40:                                  ; preds = %assert.exit.L38
  ...
  %67 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %it), !dbg !93
...
foreach.head.L45:                                 ; preds = %foreach.tail.L45, %assert.exit.L42
  %71 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %10), !dbg !96
  br i1 %71, label %foreach.body.L45, label %foreach.exit.L45, !dbg !96

foreach.body.L45:                                 ; preds = %foreach.head.L45
  %72 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr %10), !dbg !96
...
foreach.exit.L45:                                 ; preds = %foreach.head.L45
  %76 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 0), !dbg !98
...
assert.exit.L48:                                  ; preds = %foreach.exit.L45
  %80 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 1), !dbg !100
...
assert.exit.L49:                                  ; preds = %assert.exit.L48
  %84 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 2), !dbg !102
...
foreach.head.L53:                                 ; preds = %foreach.tail.L53, %assert.exit.L50
  %89 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %11), !dbg !106
  br i1 %89, label %foreach.body.L53, label %foreach.exit.L53, !dbg !106

foreach.body.L53:                                 ; preds = %foreach.head.L53
  %90 = call ptr @_ZN14VectorIteratorIiE3getEv(ptr %11), !dbg !106
...
foreach.exit.L53:                                 ; preds = %foreach.head.L53
  %94 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 0), !dbg !108
...
assert.exit.L56:                                  ; preds = %foreach.exit.L53
  %98 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 1), !dbg !110
...
assert.exit.L57:                                  ; preds = %assert.exit.L56
  %102 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 2), !dbg !112
...
foreach.head.L60:                                 ; preds = %foreach.tail.L60, %assert.exit.L58
  %107 = call i1 @_ZN14VectorIteratorIiE7isValidEv(ptr %12), !dbg !119
  br i1 %107, label %foreach.body.L60, label %foreach.exit.L60, !dbg !119

foreach.body.L60:                                 ; preds = %foreach.head.L60
  %pair3 = call %struct.Pair @_ZN14VectorIteratorIiE6getIdxEv(ptr %12), !dbg !119
...
foreach.tail.L60:                                 ; preds = %foreach.body.L60
  call void @_ZN14VectorIteratorIiE4nextEv(ptr %12), !dbg !120
  br label %foreach.head.L60, !dbg !120

foreach.exit.L60:                                 ; preds = %foreach.head.L60
  %115 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 0), !dbg !121
...
assert.exit.L63:                                  ; preds = %foreach.exit.L60
  %119 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 1), !dbg !123
...
assert.exit.L64:                                  ; preds = %assert.exit.L63
  %123 = call ptr @_ZN6VectorIiE3getEj(ptr %vi, i32 2), !dbg !125
...
!28 = !DICompositeType(tag: DW_TAG_structure_type, name: "Vector", scope: !5, file: !5, line: 27, size: 192, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !29, identifier: "struct.Vector")
!29 = !{!30, !32, !34}
!30 = !DIDerivedType(tag: DW_TAG_member, name: "contents", scope: !28, file: !5, line: 28, baseType: !31, size: 64)
!31 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !18, size: 64)
!32 = !DIDerivedType(tag: DW_TAG_member, name: "capacity", scope: !28, file: !5, line: 29, baseType: !33, size: 64, offset: 64)
!33 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!34 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !28, file: !5, line: 30, baseType: !33, size: 64, offset: 128)
...
!48 = !DICompositeType(tag: DW_TAG_structure_type, name: "Vector", scope: !5, file: !5, line: 27, size: 192, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !49, identifier: "struct.Vector")
!49 = !{!50, !51, !52}
!50 = !DIDerivedType(tag: DW_TAG_member, name: "contents", scope: !48, file: !5, line: 28, baseType: !31, size: 64)
!51 = !DIDerivedType(tag: DW_TAG_member, name: "capacity", scope: !48, file: !5, line: 29, baseType: !33, size: 64, offset: 64)
!52 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !48, file: !5, line: 30, baseType: !33, size: 64, offset: 128)
