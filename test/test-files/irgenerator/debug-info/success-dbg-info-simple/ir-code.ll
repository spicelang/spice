...
define private %struct.TestStruct @_Z3fctRi(ptr %0) !dbg !24 {
  ...
  call void @_ZN6String4ctorEPc(ptr %2, ptr @anon.string.0), !dbg !57
  %3 = getelementptr inbounds %struct.TestStruct, ptr %ts, i32 0, i32 0, !dbg !58
  store i64 6, ptr %3, align 8, !dbg !58
  %4 = load %struct.String, ptr %2, align 8, !dbg !58
  %5 = getelementptr inbounds %struct.TestStruct, ptr %ts, i32 0, i32 1, !dbg !58
  store %struct.String %4, ptr %5, align 8, !dbg !58
  %6 = load ptr, ptr %ref, align 8, !dbg !58
  %7 = load i32, ptr %6, align 4, !dbg !58
  %8 = getelementptr inbounds %struct.TestStruct, ptr %ts, i32 0, i32 2, !dbg !58
  call void @llvm.dbg.declare(metadata ptr %ts, metadata !59, metadata !DIExpression()), !dbg !58
  store i32 %7, ptr %8, align 4, !dbg !58
  %9 = load %struct.TestStruct, ptr %ts, align 8, !dbg !70
  ret %struct.TestStruct %9, !dbg !70
}
...
define dso_local i32 @main() #1 !dbg !71 {
  ...
  %1 = call %struct.TestStruct @_Z3fctRi(ptr %test), !dbg !78
  store %struct.TestStruct %1, ptr %res, align 8, !dbg !78
  call void @llvm.dbg.declare(metadata ptr %res, metadata !79, metadata !DIExpression()), !dbg !78
  store %struct.TestStruct %1, ptr %res, align 8, !dbg !78
  %lng_addr = getelementptr inbounds %struct.TestStruct, ptr %res, i32 0, i32 0, !dbg !90
  %2 = load i64, ptr %lng_addr, align 8, !dbg !90
  %3 = call i32 (ptr, ...) @printf(ptr noundef @printf.str.0, i64 %2), !dbg !90
  %4 = getelementptr inbounds %struct.TestStruct, ptr %res, i32 0, i32 1, !dbg !91
  %5 = call ptr @_ZN6String6getRawEv(ptr %4), !dbg !91
  %6 = call i32 (ptr, ...) @printf(ptr noundef @printf.str.1, ptr %5), !dbg !91
  %i_addr = getelementptr inbounds %struct.TestStruct, ptr %res, i32 0, i32 2, !dbg !92
...
!24 = distinct !DISubprogram(name: "fct", linkageName: "_Z3fctRi", scope: !7, file: !7, line: 7, type: !25, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !43)
...
!32 = !DICompositeType(tag: DW_TAG_structure_type, name: "String", scope: !7, file: !7, line: 15, size: 192, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !33, identifier: "struct.String")
!33 = !{!34, !37, !39}
!34 = !DIDerivedType(tag: DW_TAG_member, name: "contents", scope: !32, file: !7, line: 16, baseType: !35, size: 64)
!35 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !36, size: 64)
!36 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_unsigned_char)
!37 = !DIDerivedType(tag: DW_TAG_member, name: "capacity", scope: !32, file: !7, line: 17, baseType: !38, size: 64, offset: 64)
!38 = !DIBasicType(name: "unsigned long", size: 64, encoding: DW_ATE_unsigned)
!39 = !DIDerivedType(tag: DW_TAG_member, name: "length", scope: !32, file: !7, line: 18, baseType: !38, size: 64, offset: 128)
...
!45 = !DICompositeType(tag: DW_TAG_structure_type, name: "TestStruct", scope: !7, file: !7, line: 1, size: 320, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !46, identifier: "struct.TestStruct")
!46 = !{!47, !48, !54}
...
!49 = !DICompositeType(tag: DW_TAG_structure_type, name: "String", scope: !7, file: !7, line: 15, size: 192, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !50, identifier: "struct.String")
!50 = !{!51, !52, !53}
!51 = !DIDerivedType(tag: DW_TAG_member, name: "contents", scope: !49, file: !7, line: 16, baseType: !35, size: 64)
!52 = !DIDerivedType(tag: DW_TAG_member, name: "capacity", scope: !49, file: !7, line: 17, baseType: !38, size: 64, offset: 64)
!53 = !DIDerivedType(tag: DW_TAG_member, name: "length", scope: !49, file: !7, line: 18, baseType: !38, size: 64, offset: 128)
...
!60 = !DICompositeType(tag: DW_TAG_structure_type, name: "TestStruct", scope: !7, file: !7, line: 1, size: 320, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !61, identifier: "struct.TestStruct")
!61 = !{!62, !63, !69}
...
!64 = !DICompositeType(tag: DW_TAG_structure_type, name: "String", scope: !7, file: !7, line: 15, size: 192, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !65, identifier: "struct.String")
!65 = !{!66, !67, !68}
!66 = !DIDerivedType(tag: DW_TAG_member, name: "contents", scope: !64, file: !7, line: 16, baseType: !35, size: 64)
!67 = !DIDerivedType(tag: DW_TAG_member, name: "capacity", scope: !64, file: !7, line: 17, baseType: !38, size: 64, offset: 64)
!68 = !DIDerivedType(tag: DW_TAG_member, name: "length", scope: !64, file: !7, line: 18, baseType: !38, size: 64, offset: 128)
...
!71 = distinct !DISubprogram(name: "main", linkageName: "_Z4mainv", scope: !7, file: !7, line: 12, type: !72, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !43)
...
!80 = !DICompositeType(tag: DW_TAG_structure_type, name: "TestStruct", scope: !7, file: !7, line: 1, size: 320, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !81, identifier: "struct.TestStruct")
!81 = !{!82, !83, !89}
...
!84 = !DICompositeType(tag: DW_TAG_structure_type, name: "String", scope: !7, file: !7, line: 15, size: 192, align: 8, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !85, identifier: "struct.String")
!85 = !{!86, !87, !88}
!86 = !DIDerivedType(tag: DW_TAG_member, name: "contents", scope: !84, file: !7, line: 16, baseType: !35, size: 64)
!87 = !DIDerivedType(tag: DW_TAG_member, name: "capacity", scope: !84, file: !7, line: 17, baseType: !38, size: 64, offset: 64)
!88 = !DIDerivedType(tag: DW_TAG_member, name: "length", scope: !84, file: !7, line: 18, baseType: !38, size: 64, offset: 128)
