...
for.body.L2:                                      ; preds = %for.body.L2, %0
  ...
  %1 = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.0, i32 noundef %counter.09)
...
for.body.L5:                                      ; preds = %for.body.L2, %for.body.L5
  ...
  %4 = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.1, i32 noundef %subCounter.08)
...
for.exit.L2:                                      ; preds = %for.body.L5
  %7 = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.2)
  ret i32 0
}
