...
@_ZTS9InnerTest = private constant [11 x i8] c"9InnerTest\00", comdat, align 4
@_ZTI9InnerTest = private constant { ptr, ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTV8TypeInfo, i64 2), ptr @_ZTS9InnerTest, ptr @_ZTI5ITest }, comdat, align 8
@_ZTV9InnerTest = private unnamed_addr constant { [3 x ptr] } { [3 x ptr] [ptr null, ptr @_ZTI9InnerTest, ptr @_ZN9InnerTest4testEv] }, comdat, align 8
