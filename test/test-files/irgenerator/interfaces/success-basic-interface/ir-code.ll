...
@_ZTS9Driveable = private constant [11 x i8] c"9Driveable\00", comdat, align 4
@_ZTV8TypeInfo = external global ptr
@_ZTI9Driveable = private constant { ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTV8TypeInfo, i64 2), ptr @_ZTS9Driveable }, comdat, align 8
@_ZTV9Driveable = private unnamed_addr constant { [4 x ptr] } { [4 x ptr] [ptr null, ptr @_ZTI9Driveable, ptr null, ptr null] }, comdat, align 8
