...
@_ZTS3Car = weak_odr dso_local constant [5 x i8] c"3Car\00", align 4
@_ZTV8TypeInfo = external global ptr
@_ZTI9Driveable = external global ptr
@_ZTI3Car = weak_odr dso_local constant { ptr, ptr, ptr } { ptr getelementptr inbounds (ptr, ptr @_ZTV8TypeInfo, i64 2), ptr @_ZTS3Car, ptr @_ZTI9Driveable }, align 8
@_ZTV3Car = weak_odr dso_local unnamed_addr constant { [4 x ptr] } { [4 x ptr] [ptr null, ptr @_ZTI3Car, ptr @_ZN3Car5driveEi, ptr @_ZN3Car9isDrivingEv] }, align 8
@printf.str.0 = private unnamed_addr constant [15 x i8] c"Is driving: %d\00", align 4

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define private fastcc void @_ZN3Car4ctorEv(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(16) initializes((0, 9)) %0) unnamed_addr #0 {
