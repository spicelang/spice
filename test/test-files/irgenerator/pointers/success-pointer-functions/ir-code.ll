...
define private void @_p__void__void__birthday__Personptr(ptr %0) {
  ...
  %3 = getelementptr inbounds %__Person__string_string_int, ptr %2, i32 0, i32 2
...
define dso_local i32 @main() #0 {
  ...
  %1 = getelementptr inbounds %__Person__string_string_int, ptr %mike, i32 0, i32 1
  %2 = load ptr, ptr %1, align 8
  %3 = getelementptr inbounds %__Person__string_string_int, ptr %mike, i32 0, i32 0
  %4 = load ptr, ptr %3, align 8
  %5 = call i32 (ptr, ...) @printf(ptr noundef @printf.str.0, ptr %2, ptr %4)
  %6 = getelementptr inbounds %__Person__string_string_int, ptr %mike, i32 0, i32 2
  %7 = load i32, ptr %6, align 4
  %8 = call i32 (ptr, ...) @printf(ptr noundef @printf.str.1, i32 %7)
  call void @_p__void__void__birthday__Personptr(ptr %mike)
  %9 = getelementptr inbounds %__Person__string_string_int, ptr %mike, i32 0, i32 2
