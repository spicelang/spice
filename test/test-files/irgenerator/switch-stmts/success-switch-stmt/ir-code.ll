...
@anon.string.0 = private unnamed_addr constant [5 x i8] c"Zero\00", align 4
@anon.string.1 = private unnamed_addr constant [4 x i8] c"One\00", align 4
@anon.string.2 = private unnamed_addr constant [4 x i8] c"Two\00", align 4
@anon.string.3 = private unnamed_addr constant [6 x i8] c"Three\00", align 4
@anon.string.4 = private unnamed_addr constant [5 x i8] c"Four\00", align 4
@anon.string.5 = private unnamed_addr constant [5 x i8] c"Five\00", align 4
@anon.string.6 = private unnamed_addr constant [4 x i8] c"Six\00", align 4
@anon.string.7 = private unnamed_addr constant [6 x i8] c"Seven\00", align 4
...
@printf.str.3 = private unnamed_addr constant [9 x i8] c"9 is %s\0A\00", align 4
@printf.str.4 = private unnamed_addr constant [9 x i8] c"2 is %s\0A\00", align 4
@printf.str.5 = private unnamed_addr constant [9 x i8] c"3 is %s\0A\00", align 4
@printf.str.6 = private unnamed_addr constant [9 x i8] c"4 is %s\0A\00", align 4
@printf.str.7 = private unnamed_addr constant [9 x i8] c"7 is %s\0A\00", align 4
@printf.str.8 = private unnamed_addr constant [9 x i8] c"6 is %s\0A\00", align 4
