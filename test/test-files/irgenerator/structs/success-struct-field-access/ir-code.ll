...
define dso_local i32 @main() #0 {
  ...
  %age_addr = getelementptr inbounds %__Person__string_string_int, ptr %john, i32 0, i32 2
  store i32 47, ptr %age_addr, align 4
  %age_addr1 = getelementptr inbounds %__Person__string_string_int, ptr %john, i32 0, i32 2
