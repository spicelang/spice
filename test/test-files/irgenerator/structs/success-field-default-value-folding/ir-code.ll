...
assert.exit.L30:                                  ; preds = %0
  ...
  br i1 %4, label %assert.exit.L31, label %assert.then.L31, !prof !5
...
assert.exit.L31:                                  ; preds = %assert.exit.L30
  ...
  %7 = xor i1 %6, true
  br i1 %7, label %assert.exit.L32, label %assert.then.L32, !prof !5
...
assert.exit.L32:                                  ; preds = %assert.exit.L31
  ...
  %10 = icmp eq i32 %9, 11
  br i1 %10, label %assert.exit.L33, label %assert.then.L33, !prof !5
...
assert.exit.L33:                                  ; preds = %assert.exit.L32
  ...
  br i1 %13, label %assert.exit.L34, label %assert.then.L34, !prof !5
...
assert.exit.L34:                                  ; preds = %assert.exit.L33
  ...
  %16 = icmp eq i64 %15, 2
  br i1 %16, label %assert.exit.L35, label %assert.then.L35, !prof !5
...
assert.exit.L35:                                  ; preds = %assert.exit.L34
  ...
  br i1 %18, label %assert.exit.L36, label %assert.then.L36, !prof !5
...
assert.exit.L36:                                  ; preds = %assert.exit.L35
  ...
  br i1 %20, label %assert.exit.L37, label %assert.then.L37, !prof !5
...
assert.exit.L37:                                  ; preds = %assert.exit.L36
  ...
  br i1 %22, label %assert.exit.L38, label %assert.then.L38, !prof !5
...
assert.exit.L38:                                  ; preds = %assert.exit.L37
  ...
  %25 = xor i1 %24, true
  br i1 %25, label %assert.exit.L39, label %assert.then.L39, !prof !5
...
assert.exit.L39:                                  ; preds = %assert.exit.L38
  ...
  br i1 %27, label %assert.exit.L40, label %assert.then.L40, !prof !5
...
assert.exit.L40:                                  ; preds = %assert.exit.L39
  ...
  %30 = xor i1 %29, true
  br i1 %30, label %assert.exit.L41, label %assert.then.L41, !prof !5
...
assert.exit.L41:                                  ; preds = %assert.exit.L40
  ...
  br i1 %33, label %assert.exit.L42, label %assert.then.L42, !prof !5
...
assert.exit.L42:                                  ; preds = %assert.exit.L41
  ...
  br i1 %36, label %assert.exit.L43, label %assert.then.L43, !prof !5
...
assert.exit.L43:                                  ; preds = %assert.exit.L42
  ...
  %39 = icmp eq i8 %38, 63
  br i1 %39, label %assert.exit.L44, label %assert.then.L44, !prof !5
...
assert.exit.L44:                                  ; preds = %assert.exit.L43
  ...
  br i1 %42, label %assert.exit.L45, label %assert.then.L45, !prof !5
...
assert.exit.L45:                                  ; preds = %assert.exit.L44
  ...
  br i1 %45, label %assert.exit.L46, label %assert.then.L46, !prof !5
...
assert.exit.L46:                                  ; preds = %assert.exit.L45
  ...
  br i1 %48, label %assert.exit.L47, label %assert.then.L47, !prof !5
...
assert.exit.L47:                                  ; preds = %assert.exit.L46
  ...
  br i1 %51, label %assert.exit.L48, label %assert.then.L48, !prof !5
...
assert.exit.L48:                                  ; preds = %assert.exit.L47
  ...
  %54 = icmp eq i32 %53, 0
  br i1 %54, label %assert.exit.L49, label %assert.then.L49, !prof !5
