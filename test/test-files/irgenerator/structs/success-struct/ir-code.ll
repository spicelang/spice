...
define dso_local i32 @main() #0 {
  ...
  %3 = getelementptr inbounds %struct.TestStruct, ptr %instance, i32 0, i32 0
  store ptr %input, ptr %3, align 8
  %4 = getelementptr inbounds %struct.TestStruct, ptr %instance, i32 0, i32 1
  store double 4.634000e+01, ptr %4, align 8
  %5 = getelementptr inbounds %struct.TestStruct, ptr %instance, i32 0, i32 2
  store ptr %nestedInstance, ptr %5, align 8
  %6 = load %struct.TestStruct, ptr %instance, align 8
  store %struct.TestStruct %6, ptr %instance1, align 8
  %nested_addr = getelementptr inbounds %struct.TestStruct, ptr %instance, i32 0, i32 2
  %7 = load ptr, ptr %nested_addr, align 8
  %nested2_addr = getelementptr inbounds %struct.Nested, ptr %7, i32 0, i32 1
  %8 = load ptr, ptr %nested2_addr, align 8
  %9 = load i1, ptr %8, align 1
  %10 = zext i1 %9 to i32
  %field2_addr = getelementptr inbounds %struct.TestStruct, ptr %instance1, i32 0, i32 1
  %11 = load double, ptr %field2_addr, align 8
  %12 = call i32 (ptr, ...) @printf(ptr noundef @printf.str.0, i32 %10, double %11)
  %nested_addr1 = getelementptr inbounds %struct.TestStruct, ptr %instance1, i32 0, i32 2
  %13 = load ptr, ptr %nested_addr1, align 8
  %nested1_addr = getelementptr inbounds %struct.Nested, ptr %13, i32 0, i32 0
  %14 = load ptr, ptr %nested1_addr, align 8
  %15 = call i32 (ptr, ...) @printf(ptr noundef @printf.str.1, ptr %14)
