...
@anon.string.1 = private unnamed_addr constant [71 x i8] c"Assertion failed: Condition 'this.field1 == true' evaluated to false.\0A\00", align 1
@anon.string.2 = private unnamed_addr constant [5 x i8] c"Test\00", align 1
@anon.string.3 = private unnamed_addr constant [73 x i8] c"Assertion failed: Condition 'this.field2 == \22Test\22' evaluated to false.\0A\00", align 1
