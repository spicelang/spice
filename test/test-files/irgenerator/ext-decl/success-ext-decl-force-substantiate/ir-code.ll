...
define dso_local noundef i32 @main() #0 {
  ...
  %3 = call noundef i32 @pthread_create(ptr noundef nonnull align 8 dereferenceable(8) %tid1, ptr noundef nonnull align 1 dereferenceable(1) null, { ptr, ptr } noundef %2, ptr noundef nonnull align 1 dereferenceable(1) null)
  ...
  %7 = call noundef i32 @pthread_create(ptr noundef nonnull align 8 dereferenceable(8) %tid2, ptr noundef nonnull align 1 dereferenceable(1) null, { ptr, ptr } noundef %6, ptr noundef nonnull align 1 dereferenceable(1) null)
  %8 = load i64, ptr %tid1, align 8
  %9 = call noundef i32 @pthread_join(i64 noundef %8, ptr noundef nonnull align 8 dereferenceable(8) null)
  %10 = load i64, ptr %tid2, align 8
  %11 = call noundef i32 @pthread_join(i64 noundef %10, ptr noundef nonnull align 8 dereferenceable(8) null)
