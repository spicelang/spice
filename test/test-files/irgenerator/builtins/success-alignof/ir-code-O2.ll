...
define dso_local noundef i32 @main() local_unnamed_addr #0 {
  ...
  %9 = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.8, i64 noundef 4)
  %10 = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.9, i64 noundef 8)
  %11 = tail call noundef i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @printf.str.10, i64 noundef 8)
  ret i32 0
}
