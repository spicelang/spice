...
define dso_local noundef i32 @main() #0 {
  ...
  %9 = call noundef i32 (ptr, ...) @printf(ptr noundef @printf.str.3, i64 noundef %8)
  store ptr @0, ptr %stringVar, align 8
  %10 = load ptr, ptr %stringVar, align 8
  %11 = call noundef i32 (ptr, ...) @printf(ptr noundef @printf.str.4, ptr noundef %10)
  store i8 0, ptr %byteVar, align 1
  %12 = load i8, ptr %byteVar, align 1
  %13 = zext i8 %12 to i32
  %14 = call noundef i32 (ptr, ...) @printf(ptr noundef @printf.str.5, i32 noundef %13)
  store i8 0, ptr %charVar, align 1
  %15 = load i8, ptr %charVar, align 1
  %16 = zext i8 %15 to i32
  %17 = call noundef i32 (ptr, ...) @printf(ptr noundef @printf.str.6, i32 noundef %16)
