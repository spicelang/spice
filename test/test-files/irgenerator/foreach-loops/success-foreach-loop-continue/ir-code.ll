...
if.then.L7:                                       ; preds = %foreach.body.L5
  %14 = call %struct.NumberIterator.2 @_Z5rangell(i64 1, i64 2)
  store %struct.NumberIterator.2 %14, ptr %1, align 8
...
declare %struct.NumberIterator.2 @_Z5rangell(i64, i64)
