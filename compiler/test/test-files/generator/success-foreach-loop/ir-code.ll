...
@intArray = dso_local global [7 x i32] [i32 1, i32 5, i32 4, i32 0, i32 12, i32 12345, i32 9]
...
entry:
  ...
  %9 = getelementptr inbounds [7 x i32], [7 x i32]* @intArray, i32 0, i32 %8
...
foreach.loop:                                     ; preds = %foreach.inc, %entry
  ...
  %foreach_idx_cmp = icmp slt i32 %14, 6
