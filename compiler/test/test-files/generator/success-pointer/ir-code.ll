...
entry:
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @1, i32 0, i32 0), i8** %5, i8* %8)
  ...
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @3, i32 0, i32 0), i8* %15)
  %17 = load i8*, i8** %13, align 8
  store i8** %13, i8*** %3, align 8
  store i8** %13, i8*** %3, align 8
  %18 = load i8**, i8*** %3, align 8
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @4, i32 0, i32 0), i8** %18)
