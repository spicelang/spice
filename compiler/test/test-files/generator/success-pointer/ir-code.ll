...
entry:
  ...
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @2, i32 0, i32 0), i8** %4, align 8
  %5 = load i8**, i8*** %ptr, align 8
  %6 = load i8*, i8** %5, align 8
  %restoredFood = alloca i8*, align 8
  store i8* %6, i8** %restoredFood, align 8
  %7 = load i8*, i8** %restoredFood, align 8
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @3, i32 0, i32 0), i8* %7)
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @4, i32 0, i32 0), i8** %restoredFood)
