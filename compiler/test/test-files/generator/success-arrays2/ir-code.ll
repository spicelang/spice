...
@intArray = dso_local global [10 x i32] [i32 1, i32 2, i32 4, i32 8, i32 16, i32 32, i32 64, i32 128, i32 256, i32 512]
...
entry:
  ...
  %12 = getelementptr inbounds [10 x i32], [10 x i32]* @intArray, i32 0, i32 %11
  ...
  %19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i32 0, i32 0), i32 %18)
  %20 = alloca i32, align 4
  store i32 9, i32* %20, align 4
  %21 = load i32, i32* %20, align 4
  %22 = getelementptr inbounds [10 x i32], [10 x i32]* @intArray, i32 0, i32 %21
  %23 = load i32, i32* %22, align 4
  %24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @2, i32 0, i32 0), i32 %23)
