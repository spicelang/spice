...
entry:
  ...
  %boolean1 = alloca %Nested, align 8
  %4 = alloca i8*, align 8
  store i8* getelementptr inbounds ([13 x i8], [13 x i8]* @0, i32 0, i32 0), i8** %4, align 8
  %5 = load i8*, i8** %4, align 8
  %6 = getelementptr inbounds %Nested, %Nested* %boolean1, i32 0, i32 0
  store i8* %5, i8** %6, align 8
  %7 = getelementptr inbounds i1, i1* %boolean, i32 0
  %8 = alloca i1*, align 8
  store i1* %boolean, i1** %8, align 8
  %9 = load i1*, i1** %8, align 8
  %10 = getelementptr inbounds %Nested, %Nested* %boolean1, i32 0, i32 1
  store i1* %9, i1** %10, align 8
  %boolean2 = alloca %TestStruct, align 8
  %11 = getelementptr inbounds i32, i32* %input, i32 0
  %12 = alloca i32*, align 8
  store i32* %input, i32** %12, align 8
  %13 = load i32*, i32** %12, align 8
  %14 = getelementptr inbounds %TestStruct, %TestStruct* %boolean2, i32 0, i32 0
  store i32* %13, i32** %14, align 8
  %15 = alloca double, align 8
  store double 4.634000e+01, double* %15, align 8
  %16 = load double, double* %15, align 8
  %17 = getelementptr inbounds %TestStruct, %TestStruct* %boolean2, i32 0, i32 1
  store double %16, double* %17, align 8
  %18 = getelementptr inbounds %Nested, %Nested* %boolean1, i32 0
  %19 = alloca %Nested*, align 8
  store %Nested* %boolean1, %Nested** %19, align 8
  %20 = load %Nested*, %Nested** %19, align 8
  %21 = getelementptr inbounds %TestStruct, %TestStruct* %boolean2, i32 0, i32 2
  store %Nested* %20, %Nested** %21, align 8
  %22 = getelementptr inbounds %TestStruct, %TestStruct* %boolean2, i32 0
  ...
  %24 = getelementptr inbounds %TestStruct, %TestStruct* %boolean2, i32 0, i32 2
  ...
  %37 = getelementptr inbounds %TestStruct, %TestStruct* %boolean2, i32 0, i32 0
