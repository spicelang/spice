...
if.then:                                          ; preds = %entry
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @0, i32 0, i32 0))
  store i32 0, i32* %3, align 4
  %9 = load i32, i32* %3, align 4
  ret i32 %9

if.end:                                           ; preds = %entry
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @1, i32 0, i32 0))
