...
| `stack_trace_address_rt` | Address translation for stack trace symbol lookups, OS-specific.     |
| `stack_trace_native_rt`  | Native stack unwinding and symbol resolution on top of libbacktrace. |
