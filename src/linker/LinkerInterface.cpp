...
void LinkerInterface::link() {
    ...
    if (cliOptions->printDebugOutput && !result.empty()) std::cout << "Linking result: " << result << std::endl;
}
 ...
 */
void LinkerInterface::addObjectFilePath(const std::string& objectFilePath) {
 ...
 */
void LinkerInterface::addLinkerFlag(const std::string& flag) {
 ...
 */
void LinkerInterface::setOutputPath(const std::string& path) {
