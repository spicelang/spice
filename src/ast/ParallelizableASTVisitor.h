...
class ValueNode;
class SignedConstantNode;
class UnsignedConstantNode;
class FctCallNode;
...
public:
  ...
  virtual std::any visitUnsignedConstant(const UnsignedConstantNode *node);
  virtual std::any visitSignedConstant(const SignedConstantNode *node);
