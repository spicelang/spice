...
enum SemanticErrorType : uint8_t {
  ...
  NO_MATCHING_CTOR_FOUND,
  COPY_CTOR_REQUIRED,
  INTERFACE_DECLARED_TWICE,
  INTERFACE_METHOD_NOT_IMPLEMENTED,
  INTERFACE_METHOD_RETURNS_INTERFACE_BY_VALUE,
  ENUM_DECLARED_TWICE,
  ...
  BUILTIN_TEMPLATE_TYPE_COUNT_MISMATCH,
  BUILTIN_ARG_COUNT_MISMATCH,
  BUILTIN_SIGNATURE_MISMATCH,
  ...
  LAMBDA_CAPTURE_ESCAPE,
  ERR_PROPAGATION_INVALID_OPERAND,
  ERR_PROPAGATION_INVALID_CONTEXT,
  DISCARDED_RESULT_VALUE,
  UNION_AMBIGUITY,
  UNION_INFINITE_SIZE,
  UNION_FIELD_TYPE_NOT_TRIVIAL,
  UNION_FIELD_MUST_NOT_BE_REFERENCE,
  DUPLICATE_UNION_DEFAULT_VALUE,
};
